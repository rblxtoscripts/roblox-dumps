...
v1.Premium.Main.BuyTicket.MouseButton1Click:Connect(function() --[[ Line: 122 | Upvalues: MarketplaceService (copy), LocalPlayer (copy), Robux (copy) ]]
	MarketplaceService:PromptProductPurchase(LocalPlayer, Robux.Products.EventPremiumTicket)
end)
ReplicatedStorage.Remotes.Misc.EventSeasonPassTouch.OnClientEvent:Connect(function() --[[ Line: 126 | Upvalues: v1 (copy), Tween (copy) ]]
...
v1.ClaimAll.MouseButton1Click:Connect(function() --[[ Line: 132 | Upvalues: SeasonPass (copy) ]]
