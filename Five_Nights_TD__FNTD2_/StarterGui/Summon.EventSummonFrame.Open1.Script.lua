...
local v1 = UDim2.new(0.533, 0, 0.239, 0)
...
script.Parent.Tutorial.Changed:Connect(function() --[[ Line: 6 | Upvalues: TweenService (copy), v2 (copy), v1 (copy) ]]
	while script.Parent.Tutorial.Value do
		...
		TweenService:Create(script.Parent.TextLabel1, TweenInfo.new(0.5, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
	...
	script.Parent.TextLabel1.TextColor3 = Color3.fromRGB(255, 255, 255)
