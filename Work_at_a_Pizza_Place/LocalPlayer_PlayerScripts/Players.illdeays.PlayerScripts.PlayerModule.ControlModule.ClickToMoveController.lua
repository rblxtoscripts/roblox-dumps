...
local t2 = {}
if not UserRaycastPerformanceImprovements then
	local function v13(p1) --[[ FindCharacterAncestor | Line: 65 | Upvalues: v13 (copy) ]]
		if not p1 then
			return
		end
		...
		if Humanoid then
			...
			return v13(p1.Parent)
		end
	end
	t2.FindCharacterAncestor = v13
	local function v14(p1, p2, p3) --[[ Raycast | Line: 77 | Upvalues: Workspace (copy), v13 (copy), v14 (copy) ]]
...
local function UpdateIgnoreTag(p1) --[[ UpdateIgnoreTag | Line: 127 | Upvalues: v16 (ref), v17 (ref), v18 (ref), v15 (ref), LocalPlayer (copy), CollectionService (copy) ]]
	if p1 == v16 then
		return
	end
	if v17 then
	...
	v17 = CollectionService:GetInstanceAddedSignal(p1):Connect(function(p1) --[[ Line: 147 | Upvalues: v15 (ref) ]]
		table.insert(v15, p1)
	end)
	v18 = CollectionService:GetInstanceRemovedSignal(p1):Connect(function(p1) --[[ Line: 151 | Upvalues: v15 (ref) ]]
		for i = 1, #v15 do
			if v15[i] == p1 then
				v15[i] = v15[#v15]
				table.remove(v15)
...
local function getIgnoreList() --[[ getIgnoreList | Line: 163 | Upvalues: v15 (ref), LocalPlayer (copy) ]]
	if v15 then
		return v15
	end
	v15 = {}
	assert(v15, "")
	table.insert(v15, LocalPlayer and LocalPlayer.Character)
	return v15
end
...
local function Pather(p1, p2, p3) --[[ Pather | Line: 214 | Upvalues: v9 (ref), LocalPlayer (copy), t3 (copy), v10 (ref), v3 (copy), getCollidableExtentsSize (copy), v6 (copy), PathfindingService (copy), v7 (ref), ClickToMoveDisplay (copy), v11 (ref), UserRaycastPerformanceImprovements (copy), v12 (copy), v15 (ref), Workspace (copy) ]]
	local t = {}
	local v1, v2
	if p3 == nil then
		v1 = v9
	...
	if v72 then
		...
		if SeatPart and SeatPart:IsA("VehicleSeat") then
			...
			if v112 then
				...
				if v2 then
					local v122 = v112:GetExtentsSize()
					v8 = v10 * 0.5 * math.sqrt(v122.X * v122.X + v122.Z * v122.Z)
					v92 = v10 * v122.Y
			...
			if v3 then
				...
				if v16 ~= nil then
					v152 = getCollidableExtentsSize(v16)
				end
			end
			if v152 == nil then
				v152 = (LocalPlayer and LocalPlayer.Character):GetExtentsSize()
			end
			assert(v152, "")
			v8 = v10 * 0.5 * math.sqrt(v152.X * v152.X + v152.Z * v152.Z)
			v92 = v10 * v152.Y
	...
	t.Recomputing = false
	function t.OnPathBlocked(p1, p2) --[[ OnPathBlocked | Line: 404 | Upvalues: t (copy), v7 (ref), ClickToMoveDisplay (ref) ]]
	...
	function t.OnRenderStepped(p1, p2) --[[ OnRenderStepped | Line: 440 | Upvalues: t (copy), v11 (ref) ]]
	...
	function t.MoveToNextWayPoint(p1, p2, p3, p4) --[[ MoveToNextWayPoint | Line: 567 | Upvalues: t (copy), v6 (ref) ]]
	...
	function t.Start(p1, p2) --[[ Start | Line: 599 | Upvalues: t (copy), ClickToMoveDisplay (ref), v7 (ref) ]]
	...
	local v22 = t.TargetPoint + t.TargetSurfaceNormal * 1.5
	if UserRaycastPerformanceImprovements then
		...
		v12.FilterDescendantsInstances = v15
		local v28 = Workspace:Raycast(v22, Vector3.new(-0, -50, -0), v12)
		if v28 then
			t.TargetPoint = v28.Position
		end
	else
		local v29 = Ray.new(v22, Vector3.new(0, -50, 0))
		if not v15 then
			v15 = {}
			assert(v15, "")
			table.insert(v15, LocalPlayer and LocalPlayer.Character)
		end
		local v36, v37 = Workspace:FindPartOnRayWithIgnoreList(v29, v15)
		if v36 then
			t.TargetPoint = v37
		end
	end
...
local v20 = nil
local v21 = nil
local function CleanupPath() --[[ CleanupPath | Line: 684 | Upvalues: v19 (ref), v20 (ref), v21 (ref) ]]
	if v19 then
		v19:Cancel()
		v19 = nil
	end
...
local function HandleMoveTo(p1, p2, p3, p4, p5) --[[ HandleMoveTo | Line: 702 | Upvalues: v19 (ref), v20 (ref), v21 (ref), GetEquippedTool (copy), v8 (ref), ClickToMoveDisplay (copy) ]]
	if v19 then
		if v19 then
			v19:Cancel()
			v19 = nil
	...
	v19 = p1
	p1:Start(p5)
	v20 = p1.Finished.Event:Connect(function() --[[ Line: 709 | Upvalues: v19 (ref), v20 (ref), v21 (ref), p3 (copy), GetEquippedTool (ref), p4 (copy) ]]
		if v19 then
			v19:Cancel()
			v19 = nil
		end
	...
	v21 = p1.PathFailed.Event:Connect(function() --[[ Line: 718 | Upvalues: v19 (ref), v20 (ref), v21 (ref), p5 (copy), v8 (ref), ClickToMoveDisplay (ref), p2 (copy) ]]
		if v19 then
			v19:Cancel()
			v19 = nil
		end
...
local function ShowPathFailedFeedback(p1) --[[ ShowPathFailedFeedback | Line: 730 | Upvalues: v19 (ref), v8 (ref), ClickToMoveDisplay (copy) ]]
	if v19 and v19:IsActive() then
		v19:Cancel()
	end
	if v8 then
		ClickToMoveDisplay.PlayFailureAnimation()
...
function OnTap(p1, p2, p3) --[[ OnTap | Line: 740 | Upvalues: Workspace (copy), LocalPlayer (copy), t3 (copy), UserRaycastPerformanceImprovements (copy), v15 (ref), v12 (copy), StarterGui (copy), Players (copy), v19 (ref), v20 (ref), v21 (ref), Pather (copy), HandleMoveTo (copy), v8 (ref), ClickToMoveDisplay (copy), t2 (copy), GetEquippedTool (copy) ]]
	...
	if #p1 == 1 or p2 then
		...
		if UserRaycastPerformanceImprovements then
			...
			repeat
				local v14, v152
				local v16 = true
				v12.FilterDescendantsInstances = v122
				local v17 = Workspace:Raycast(v6.Origin, v6.Direction * 1000, v12)
				if v17 then
					local v18 = v17.Instance
					if v18.CanCollide then
						v13 = v17
						continue
					end
					v13 = v17
					while true do
						v14 = v18:FindFirstChildOfClass("Humanoid")
						v152 = v18.Parent
						if v14 or (not v152 or v152 == Workspace) then
							break
						end
						v18 = v152
					end
			...
			if p3 and (v7 and (StarterGui:GetCore("AvatarContextMenuEnabled") and Players:GetPlayerFromCharacter(v7.Parent))) then
				...
				local v192 = Pather(Position, v13.Normal)
				if v192:IsValidPath() then
					HandleMoveTo(v192, Position, v82, Character)
					return
				end
				v192:Cleanup()
				if v19 and v19:IsActive() then
			...
			local v202 = Ray.new(v6.Origin, v6.Direction * 1000)
			if not v15 then
				v15 = {}
				assert(v15, "")
				table.insert(v15, LocalPlayer and LocalPlayer.Character)
			end
			local v27, v28, v29 = t2.Raycast(v202, true, v15)
			...
			if p3 and (v31 and (StarterGui:GetCore("AvatarContextMenuEnabled") and Players:GetPlayerFromCharacter(v31.Parent))) then
				...
				local v32 = Pather(v28, v29)
				if v32:IsValidPath() then
					HandleMoveTo(v32, v28, v30, Character)
					return
				end
				v32:Cleanup()
				if v19 and v19:IsActive() then
...
local v22 = setmetatable({}, Keyboard)
v22.__index = v22
function v22.new(p1) --[[ new | Line: 861 | Upvalues: Keyboard (copy), v22 (copy) ]]
	local v3 = setmetatable(Keyboard.new(p1), v22)
	v3.fingerTouches = {}
...
function v22.DisconnectEvents(p1) --[[ DisconnectEvents | Line: 893 ]]
...
function v22.OnTouchBegan(p1, p2, p3) --[[ OnTouchBegan | Line: 906 ]]
	if p1.fingerTouches[p2] == nil and not p3 then
		p1.numUnsunkTouches = p1.numUnsunkTouches + 1
	end
	p1.fingerTouches[p2] = p3
end
function v22.OnTouchChanged(p1, p2, p3) --[[ OnTouchChanged | Line: 913 ]]
...
function v22.OnTouchEnded(p1, p2, p3) --[[ OnTouchEnded | Line: 922 ]]
	if p1.fingerTouches[p2] ~= nil and p1.fingerTouches[p2] == false then
		p1.numUnsunkTouches = p1.numUnsunkTouches - 1
	end
	p1.fingerTouches[p2] = nil
end
function v22.OnCharacterAdded(p1, p2) --[[ OnCharacterAdded | Line: 930 | Upvalues: UserInputService (copy), t (copy), v19 (ref), v20 (ref), v21 (ref), ClickToMoveDisplay (copy), GuiService (copy) ]]
	p1:DisconnectEvents()
	p1.inputBeganConn = UserInputService.InputBegan:Connect(function(p12, p2) --[[ Line: 933 | Upvalues: p1 (copy), t (ref), v19 (ref), v20 (ref), v21 (ref), ClickToMoveDisplay (ref) ]]
	...
	p1.inputChangedConn = UserInputService.InputChanged:Connect(function(p12, p2) --[[ Line: 954 | Upvalues: p1 (copy) ]]
		if p12.UserInputType ~= Enum.UserInputType.Touch then
			return
		end
		p1:OnTouchChanged(p12, p2)
	end)
	p1.inputEndedConn = UserInputService.InputEnded:Connect(function(p12, p2) --[[ Line: 960 | Upvalues: p1 (copy), v19 (ref) ]]
		if p12.UserInputType == Enum.UserInputType.Touch then
		...
		if not (p1.mouse2UpTime - p1.mouse2DownTime < 0.25 and ((Position - p1.mouse2DownPos).magnitude < 5 and (v19 or p1.keyboardMoveVector.Magnitude <= 0))) then
			return
		end
		OnTap({ Position })
	end)
	p1.tapConn = UserInputService.TouchTap:Connect(function(p1, p2) --[[ Line: 977 ]]
		if p2 then
			return
		end
		OnTap(p1, nil, true)
	end)
	p1.menuOpenedConnection = GuiService.MenuOpened:Connect(function() --[[ Line: 983 | Upvalues: v19 (ref), v20 (ref), v21 (ref) ]]
		if v19 then
			v19:Cancel()
			v19 = nil
		end
	...
	local function OnCharacterChildAdded(p12) --[[ OnCharacterChildAdded | Line: 987 | Upvalues: UserInputService (ref), p1 (copy) ]]
		if UserInputService.TouchEnabled and p12:IsA("Tool") then
		...
		p1.humanoidDiedConn = p12.Died:Connect(function() --[[ Line: 995 ]] end)
	end
	p1.characterChildAddedConn = p2.ChildAdded:Connect(function(p1) --[[ Line: 1003 | Upvalues: OnCharacterChildAdded (copy) ]]
		OnCharacterChildAdded(p1)
	end)
	p1.characterChildRemovedConn = p2.ChildRemoved:Connect(function(p1) --[[ Line: 1006 | Upvalues: UserInputService (ref) ]]
		if not (UserInputService.TouchEnabled and p1:IsA("Tool")) then
			return
		end
...
function v22.Start(p1) --[[ Start | Line: 1018 ]]
	p1:Enable(true)
end
function v22.Stop(p1) --[[ Stop | Line: 1022 ]]
	p1:Enable(false)
end
function v22.CleanupPath(p1) --[[ CleanupPath | Line: 1026 | Upvalues: v19 (ref), v20 (ref), v21 (ref) ]]
	if v19 then
		v19:Cancel()
		v19 = nil
	end
...
function v22.Enable(p1, p2, p3, p4) --[[ Enable | Line: 1030 | Upvalues: LocalPlayer (copy), v19 (ref), v20 (ref), v21 (ref), UserInputService (copy), Keyboard (copy) ]]
	if p2 then
		if not p1.running then
			if LocalPlayer.Character then
				p1:OnCharacterAdded(LocalPlayer.Character)
			end
			p1.onCharacterAddedConn = LocalPlayer.CharacterAdded:Connect(function(p12) --[[ Line: 1036 | Upvalues: p1 (copy) ]]
...
function v22.OnRenderStepped(p1, p2) --[[ OnRenderStepped | Line: 1075 | Upvalues: v19 (ref) ]]
	p1.isJumping = false
	if v19 then
		v19:OnRenderStepped(p2)
		if v19 then
			p1.moveVector = v19.NextActionMoveDirection
			p1.moveVectorIsCameraRelative = false
			if v19.NextActionJump then
				p1.isJumping = true
			end
		else
...
function v22.UpdateMovement(p1, p2) --[[ UpdateMovement | Line: 1110 ]]
...
function v22.UpdateJump(p1) --[[ UpdateJump | Line: 1119 ]] end
function v22.SetShowPath(p1, p2) --[[ SetShowPath | Line: 1124 | Upvalues: v7 (ref) ]]
	v7 = p2
end
function v22.GetShowPath(p1) --[[ GetShowPath | Line: 1128 | Upvalues: v7 (ref) ]]
	return v7
end
function v22.SetWaypointTexture(p1, p2) --[[ SetWaypointTexture | Line: 1132 | Upvalues: ClickToMoveDisplay (copy) ]]
	ClickToMoveDisplay.SetWaypointTexture(p2)
end
function v22.GetWaypointTexture(p1) --[[ GetWaypointTexture | Line: 1136 | Upvalues: ClickToMoveDisplay (copy) ]]
	return ClickToMoveDisplay.GetWaypointTexture()
end
function v22.SetWaypointRadius(p1, p2) --[[ SetWaypointRadius | Line: 1140 | Upvalues: ClickToMoveDisplay (copy) ]]
	ClickToMoveDisplay.SetWaypointRadius(p2)
end
function v22.GetWaypointRadius(p1) --[[ GetWaypointRadius | Line: 1144 | Upvalues: ClickToMoveDisplay (copy) ]]
	return ClickToMoveDisplay.GetWaypointRadius()
end
function v22.SetEndWaypointTexture(p1, p2) --[[ SetEndWaypointTexture | Line: 1148 | Upvalues: ClickToMoveDisplay (copy) ]]
	ClickToMoveDisplay.SetEndWaypointTexture(p2)
end
function v22.GetEndWaypointTexture(p1) --[[ GetEndWaypointTexture | Line: 1152 | Upvalues: ClickToMoveDisplay (copy) ]]
	return ClickToMoveDisplay.GetEndWaypointTexture()
end
function v22.SetWaypointsAlwaysOnTop(p1, p2) --[[ SetWaypointsAlwaysOnTop | Line: 1156 | Upvalues: ClickToMoveDisplay (copy) ]]
	ClickToMoveDisplay.SetWaypointsAlwaysOnTop(p2)
end
function v22.GetWaypointsAlwaysOnTop(p1) --[[ GetWaypointsAlwaysOnTop | Line: 1160 | Upvalues: ClickToMoveDisplay (copy) ]]
	return ClickToMoveDisplay.GetWaypointsAlwaysOnTop()
end
function v22.SetFailureAnimationEnabled(p1, p2) --[[ SetFailureAnimationEnabled | Line: 1164 | Upvalues: v8 (ref) ]]
	v8 = p2
end
function v22.GetFailureAnimationEnabled(p1) --[[ GetFailureAnimationEnabled | Line: 1168 | Upvalues: v8 (ref) ]]
	return v8
end
function v22.SetIgnoredPartsTag(p1, p2) --[[ SetIgnoredPartsTag | Line: 1172 | Upvalues: UpdateIgnoreTag (copy) ]]
	UpdateIgnoreTag(p2)
end
function v22.GetIgnoredPartsTag(p1) --[[ GetIgnoredPartsTag | Line: 1176 | Upvalues: v16 (ref) ]]
	return v16
end
function v22.SetUseDirectPath(p1, p2) --[[ SetUseDirectPath | Line: 1180 | Upvalues: v9 (ref) ]]
	v9 = p2
end
function v22.GetUseDirectPath(p1) --[[ GetUseDirectPath | Line: 1184 | Upvalues: v9 (ref) ]]
	return v9
end
function v22.SetAgentSizeIncreaseFactor(p1, p2) --[[ SetAgentSizeIncreaseFactor | Line: 1188 | Upvalues: v10 (ref) ]]
	v10 = p2 / 100 + 1
end
function v22.GetAgentSizeIncreaseFactor(p1) --[[ GetAgentSizeIncreaseFactor | Line: 1192 | Upvalues: v10 (ref) ]]
	return (v10 - 1) * 100
end
function v22.SetUnreachableWaypointTimeout(p1, p2) --[[ SetUnreachableWaypointTimeout | Line: 1196 | Upvalues: v11 (ref) ]]
	v11 = p2
end
function v22.GetUnreachableWaypointTimeout(p1) --[[ GetUnreachableWaypointTimeout | Line: 1200 | Upvalues: v11 (ref) ]]
	return v11
end
function v22.SetUserJumpEnabled(p1, p2) --[[ SetUserJumpEnabled | Line: 1204 ]]
	p1.jumpEnabled = p2
...
function v22.GetUserJumpEnabled(p1) --[[ GetUserJumpEnabled | Line: 1211 ]]
	return p1.jumpEnabled
end
function v22.MoveTo(p1, p2, p3, p4) --[[ MoveTo | Line: 1215 | Upvalues: LocalPlayer (copy), Pather (copy), HandleMoveTo (copy) ]]
	local Character = LocalPlayer.Character
