...
if not v18 then
	LoadHouse.MouseButton1Click:Connect(function() --[[ Line: 89 | Upvalues: LoadHouse (copy), v2 (copy), v4 (copy), v15 (ref) ]]
		LoadHouse.Visible = false
		v2.LoadingScreen.Visible = true
		local v1 = v4:SendData("SetHouseType", "HouseChannel", 10, v15)
		wait(1)
	...
	function Refresh() --[[ Refresh | Line: 102 | Upvalues: v15 (ref), v11 (ref), Tabs (copy), v3 (copy), ScrollingFrame (copy), LoadHouse (copy), v12 (ref), t (copy), v13 (ref), Template (copy), v14 (ref), LocalPlayer (copy), v8 (copy), v9 (copy), v17 (ref) ]]
		local count_2 = 0
		...
		local v32 = v11[v15] == nil
		LoadHouse.Visible = if v12 == v15 then false else v11[v15]
		for i2, v in ipairs(t[v15]) do
			local v6
			local IsBundle = v.IsBundle
			v6 = if v13 + 1 < v.Index and v.GamepassId ~= nil then true elseif v.GamepassId == "Cabin" then true else false
			local v7 = Template:Clone()
			v7.Selectable = if v.Index <= v13 then true else false
			v7.LayoutOrder = i2
			v7.UpgradeName.Text = v.Name
			v7.Price.Visible = if v13 < v.Index then not IsBundle else false
			v7.Price.PriceText.Text = v.Id == v14 and v3.FormatNumber("Number", v.Price, v7.Price.PriceText) or (if v13 + 1 < v.Index then "???" elseif v32 then "???" else "")
			...
			v7.Buy.Visible = if v13 < v.Index then true else v6
			v7.Locked.Visible = if v13 + 1 < v.Index then true else v32
			v7.Locked.EstateRequired.Visible = if v32 then if v.Index == 1 then not IsBundle and not v6 else false else v32
			v7.BackgroundBottom.Checkmark.Visible = if v.Index <= v13 then true else false
			if v.Id == v14 or (v6 or IsBundle) then
				v7.Buy.MouseButton1Click:Connect(function() --[[ Line: 167 | Upvalues: v6 (copy), v (copy), v14 (ref), IsBundle (copy), v3 (ref), LocalPlayer (ref), v8 (ref), v15 (ref), v9 (ref) ]]
					if v6 and v.Id ~= v14 or IsBundle then
						if IsBundle then
						...
						if not v8:InvokeServer("BuyHouseUpgradeWithCoins", v.Id, v15) then
							return
						end
						v9:SetVisible(false)
					end
	...
	function TabChanged(p1_2, p2_2, p3_2) --[[ TabChanged | Line: 198 | Upvalues: v2 (copy), v15 (ref), v16 (ref), v11 (ref), v13 (ref), v3 (copy), v14 (ref) ]]
		if p1_2 ~= v2 then
			return
		end
		v15 = p2_2.Name
		v16 = v11[v15] and v11[v15].Upgrade or nil
		v13 = v11[v15] and v3.HouseInfo[v15][v16].Index or 0
		v14 = v16 and v3.HouseInfo[v15][v16].NextUpgrade or nil
	...
	task.spawn(function() --[[ Line: 424 | Upvalues: LocalPlayer (copy), v17 (ref), v16 (ref), v12 (ref), UIEvents (copy), v22 (copy), v4 (copy) ]]
		local v1 = nil
		v1 = LocalPlayer:WaitForChild("Moneyz"):GetPropertyChangedSignal("Value"):Connect(function() --[[ Line: 426 | Upvalues: v17 (ref), v16 (ref), LocalPlayer (ref), v12 (ref), v1 (ref), UIEvents (ref), v22 (ref), v4 (ref) ]]
			if not v17 or (not v16 or (v16 ~= "Shack" or (not (LocalPlayer.Moneyz.Value >= 100) or v12 ~= "Brick"))) then
				return
			end
			v1:Disconnect()
			local v13 = nil
			v13 = UIEvents.TopbarButtonPressed.Event:connect(function(p1_2) --[[ Line: 430 | Upvalues: v22 (ref), v13 (ref), v16 (ref), v17 (ref), v4 (ref) ]]
				...
				local v1 = true
				local v2 = nil
				v2 = v17.MouseButton1Click:connect(function() --[[ Line: 438 | Upvalues: v2 (ref), v1 (ref) ]]
					v2:disconnect()
					v1 = true
				end)
				local BackgroundColor3 = v17.Foreground.BackgroundColor3
				local v3 = Color3.new(BackgroundColor3.R + 0.1, BackgroundColor3.G + 0.1, BackgroundColor3.B + 0.1)
				while v1 and (v17 and v17.Parent) do
					v17.Foreground.BackgroundColor3 = BackgroundColor3
					v4:QuickTween(v17.Foreground, 0.1, {
						BackgroundColor3 = v3
					})
					wait(0.3)
				end
