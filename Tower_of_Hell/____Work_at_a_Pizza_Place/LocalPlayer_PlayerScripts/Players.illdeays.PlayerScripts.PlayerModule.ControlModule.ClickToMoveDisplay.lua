...
local function placePathWaypoint(p1, p2) --[[ placePathWaypoint | Line: 152 | Upvalues: UserRaycastPerformanceImprovements (copy), v11 (copy), Workspace (copy), LocalPlayer (copy) ]]
...
function t4.NewDisplayModel(p1, p2) --[[ NewDisplayModel | Line: 268 | Upvalues: v14 (ref), placePathWaypoint (copy), UserRaycastPerformanceImprovements (copy), v11 (copy), Workspace (copy), LocalPlayer (copy) ]]
	local v1 = v14:Clone()
	placePathWaypoint(v1, p2)
	if UserRaycastPerformanceImprovements then
		v11.FilterDescendantsInstances = { Workspace.CurrentCamera, LocalPlayer.Character }
