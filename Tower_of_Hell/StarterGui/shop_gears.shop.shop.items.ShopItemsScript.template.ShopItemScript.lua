...
v1.TouchTap:Connect(function() --[[ Line: 152 | Upvalues: v1 (copy), v3 (ref), buy (copy) ]]
...
coins.Changed:Connect(function() --[[ Line: 163 | Upvalues: updatePrice (copy) ]]
	updatePrice()
end)
workspace.ChildAdded:Connect(function(p1) --[[ Line: 164 | Upvalues: updatePrice (copy) ]]
...
game:GetService("RunService").RenderStepped:Connect(function() --[[ Line: 171 | Upvalues: v4 (ref), v2 (copy), updatePrice (copy) ]]
