...
local function update() --[[ update | Line: 38 | Upvalues: uiStyle (copy), addObject (copy) ]]
	script.Parent.shop.BackgroundColor3 = uiStyle.BackgroundColor.Value
	script.Parent.shop.BackgroundTransparency = uiStyle.BackgroundTransparency.Value
	script.Parent.shop.tabsBackground.BackgroundColor3 = uiStyle.BackgroundColor.Value
	script.Parent.shop.tabsBackground.BackgroundTransparency = uiStyle.BackgroundTransparency.Value
	script.Parent.shop.tabsBackground.corner.ImageColor3 = uiStyle.BackgroundColor.Value
	script.Parent.shop.tabsBackground.corner.ImageTransparency = uiStyle.BackgroundTransparency.Value
