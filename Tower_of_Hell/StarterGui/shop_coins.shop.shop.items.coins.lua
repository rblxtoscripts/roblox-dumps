...
local function buyProduct(p1) --[[ buyProduct | Line: 14 ]]
...
for k, v in pairs(script.Parent:GetChildren()) do
	if v:IsA("GuiBase") then
		v.InputBegan:Connect(function(p1) --[[ Line: 24 | Upvalues: v (copy), buyProduct (copy) ]]
		...
		v.InputEnded:Connect(function(p1) --[[ Line: 31 | Upvalues: v (copy) ]]
		...
		v.TouchTap:Connect(function() --[[ Line: 36 | Upvalues: v (copy), buyProduct (copy) ]]
		...
		spawn(function() --[[ Line: 43 | Upvalues: v (copy) ]]
...
game:GetService("UserInputService").InputBegan:Connect(function(p1) --[[ Line: 56 | Upvalues: buyProduct (copy) ]]
...
script.Parent.Parent.selected.Changed:Connect(function() --[[ Line: 63 | Upvalues: TweenService (copy), v1 (copy) ]]
	local selected = script.Parent.Parent.selected.Value
	for k, v in pairs(script.Parent:GetChildren()) do
...
local function f2() --[[ Line: 92 | Upvalues: gridLayoutHelper (copy) ]]
