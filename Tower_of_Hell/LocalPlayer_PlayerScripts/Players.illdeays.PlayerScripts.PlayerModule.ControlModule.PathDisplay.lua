...
local function retrieveFromPool() --[[ retrieveFromPool | Line: 34 | Upvalues: t2 (copy), v1 (ref) ]]
	local v12 = t2[1]
	if v12 then
		t2[1] = t2[v1]
		t2[v1] = nil
...
local function returnToPool(p1) --[[ returnToPool | Line: 45 | Upvalues: v1 (ref), t2 (copy) ]]
	v1 = v1 + 1
	t2[v1] = p1
end
local function renderPoint(p1, p2) --[[ renderPoint | Line: 50 | Upvalues: v1 (ref), t2 (copy), PathDisplayPoints (copy) ]]
	if v1 == 0 then
		return nil
	end
...
function t.setCurrentPoints(p1) --[[ setCurrentPoints | Line: 69 | Upvalues: t3 (ref) ]]
	t3 = if typeof(p1) == "table" then p1 else {}
end
function t.clearRenderedPath() --[[ clearRenderedPath | Line: 77 | Upvalues: t4 (ref), v1 (ref), t2 (copy), PathDisplayPoints (copy) ]]
...
function t.renderPath() --[[ renderPath | Line: 86 | Upvalues: t (copy), t3 (ref), t4 (ref), renderPoint (copy), PathDisplayPoints (copy) ]]
	t.clearRenderedPath()
