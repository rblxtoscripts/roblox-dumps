...
v1.__index = v1
function v1.new(p1) --[[ new | Line: 21 | Upvalues: BaseCharacterController (copy), v1 (copy), None (copy) ]]
...
function v1.Enable(p1, p2) --[[ Enable | Line: 37 | Upvalues: UserInputService (copy), None (copy) ]]
...
function v1.GetHighestPriorityGamepad(p1) --[[ GetHighestPriorityGamepad | Line: 77 | Upvalues: UserInputService (copy), None (copy) ]]
	local v2 = None
...
function v1.BindContextActions(p1) --[[ BindContextActions | Line: 88 | Upvalues: None (copy), ContextActionService (copy) ]]
	if p1.activeGamepad == None then
		return false
	else
		ContextActionService:BindActivate(p1.activeGamepad, Enum.KeyCode.ButtonR2)
		ContextActionService:BindActionAtPriority("jumpAction", function(p12, p2, p3) --[[ Line: 95 | Upvalues: p1 (copy) ]]
			p1.isJumping = p2 == Enum.UserInputState.Begin
			return Enum.ContextActionResult.Sink
		end, false, p1.CONTROL_ACTION_PRIORITY, Enum.KeyCode.ButtonA)
		ContextActionService:BindActionAtPriority("moveThumbstick", function(p12, p2, p3) --[[ Line: 100 | Upvalues: p1 (copy) ]]
