...
v1.__index = v1
function v1.new() --[[ new | Line: 43 | Upvalues: BaseCamera (copy), v1 (copy) ]]
...
function v1.LoadOrCreateNumberValueParameter(p1, p2, p3, p4) --[[ LoadOrCreateNumberValueParameter | Line: 82 ]]
	...
	p1.changedSignalConnections[p2] = v1.Changed:Connect(function(p12) --[[ Line: 102 | Upvalues: p1 (copy), p2 (copy), p4 (copy) ]]
		p1.externalProperties[p2] = p12
		p4(p1)
	end)
end
function v1.SetAndBoundsCheckAzimuthValues(p1) --[[ SetAndBoundsCheckAzimuthValues | Line: 109 ]]
...
function v1.SetAndBoundsCheckElevationValues(p1) --[[ SetAndBoundsCheckElevationValues | Line: 119 ]]
...
function v1.SetAndBoundsCheckDistanceValues(p1) --[[ SetAndBoundsCheckDistanceValues | Line: 135 ]]
...
function v1.LoadNumberValueParameters(p1) --[[ LoadNumberValueParameters | Line: 143 ]]
...
function v1.GetModuleName(p1) --[[ GetModuleName | Line: 168 ]]
	return "OrbitalCamera"
end
function v1.SetInitialOrientation(p1, p2) --[[ SetInitialOrientation | Line: 172 | Upvalues: CameraUtils (copy) ]]
...
function v1.GetCameraToSubjectDistance(p1) --[[ GetCameraToSubjectDistance | Line: 190 ]]
	return p1.curDistance
end
function v1.SetCameraToSubjectDistance(p1, p2) --[[ SetCameraToSubjectDistance | Line: 194 | Upvalues: Players (copy) ]]
...
function v1.CalculateNewLookVector(p1, p2, p3) --[[ CalculateNewLookVector | Line: 207 ]]
...
function v1.Update(p1, p2) --[[ Update | Line: 218 | Upvalues: CameraInput (copy), Players (copy), VRService (copy) ]]
	local v1 = tick()
