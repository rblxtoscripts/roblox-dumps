...
local function thumbstick(p1, p2, p3) --[[ thumbstick | Line: 212 | Upvalues: t3 (copy), thumbstickCurve (ref) ]]
	local Position = p3.Position
	t3[p3.KeyCode.Name] = Vector2.new(thumbstickCurve(Position.X), -thumbstickCurve(Position.Y))
	return Enum.ContextActionResult.Pass
end
local function mouseMovement(p1) --[[ mouseMovement | Line: 218 | Upvalues: t5 (copy) ]]
	local Delta = p1.Delta
	t5.Movement = Vector2.new(Delta.X, Delta.Y)
end
local function mouseWheel(p1, p2, p3) --[[ mouseWheel | Line: 223 | Upvalues: t5 (copy) ]]
	t5.Wheel = p3.Position.Z
	return Enum.ContextActionResult.Pass
end
local function keypress(p1, p2, p3) --[[ keypress | Line: 228 | Upvalues: t4 (copy) ]]
	t4[p3.KeyCode.Name] = if p2 == Enum.UserInputState.Begin then 1 else 0
end
local function gamepadZoomPress(p1, p2, p3) --[[ gamepadZoomPress | Line: 232 | Upvalues: v14 (copy) ]]
	if p2 ~= Enum.UserInputState.Begin then
		return
	end
	v14:Fire()
end
local function gamepadReset(p1, p2, p3) --[[ gamepadReset | Line: 238 | Upvalues: v15 (copy) ]]
	if p2 ~= Enum.UserInputState.Begin then
		return
	end
	v15:Fire()
end
local function resetInputDevices() --[[ resetInputDevices | Line: 244 | Upvalues: t3 (copy), t4 (copy), t5 (copy), t6 (copy) ]]
...
local v16 = nil
local v17 = nil
local function touchBegan(p1, p2) --[[ touchBegan | Line: 268 | Upvalues: v16 (ref), isInDynamicThumbstickArea (copy), v13 (ref), t7 (ref) ]]
...
local function touchEnded(p1, p2) --[[ touchEnded | Line: 288 | Upvalues: v16 (ref), t7 (ref), v17 (ref), v13 (ref) ]]
...
local function touchChanged(p1, p2) --[[ touchChanged | Line: 307 | Upvalues: v16 (ref), t7 (ref), t6 (copy), v17 (ref) ]]
	assert(if p1.UserInputType == Enum.UserInputType.Touch then true else false)
...
local function resetTouchState() --[[ resetTouchState | Line: 351 | Upvalues: t7 (ref), v16 (ref), v17 (ref), v7 (ref), v13 (ref) ]]
	t7 = {}
	v16 = nil
	v17 = nil
	if not v7 then
...
local function pointerAction(p1, p2, p3, p4) --[[ pointerAction | Line: 361 | Upvalues: t5 (copy) ]]
	if p4 then
		return
	end
	t5.Wheel = p1
...
local function inputBegan(p1, p2) --[[ inputBegan | Line: 369 | Upvalues: touchBegan (ref), v13 (ref) ]]
...
local function inputChanged(p1, p2) --[[ inputChanged | Line: 378 | Upvalues: touchChanged (ref), t5 (copy) ]]
	if p1.UserInputType == Enum.UserInputType.Touch then
		touchChanged(p1, p2)
		return
	end
...
local function inputEnded(p1, p2) --[[ inputEnded | Line: 387 | Upvalues: touchEnded (ref), v13 (ref) ]]
	if p1.UserInputType == Enum.UserInputType.Touch then
		touchEnded(p1, p2)
		return
	end
...
local v18 = false
function t.setInputEnabled(p1) --[[ setInputEnabled | Line: 398 | Upvalues: v18 (ref), resetInputDevices (copy), resetTouchState (ref), ContextActionService (copy), thumbstick (copy), Default (copy), keypress (copy), VRService (copy), gamepadReset (copy), gamepadZoomPress (copy), t2 (ref), UserInputService (copy), inputBegan (copy), inputChanged (copy), inputEnded (copy), pointerAction (copy), v7 (ref) ]]
	if v18 == p1 then
		return
	end
	v18 = p1
...
function t.getInputEnabled() --[[ getInputEnabled | Line: 470 | Upvalues: v18 (ref) ]]
	return v18
end
function t.resetInputForFrameEnd() --[[ resetInputForFrameEnd | Line: 474 | Upvalues: t5 (copy), t6 (copy) ]]
...
local v20 = false
local v21 = 0
function t.getHoldPan() --[[ getHoldPan | Line: 495 | Upvalues: v19 (ref) ]]
	return v19
end
function t.getTogglePan() --[[ getTogglePan | Line: 499 | Upvalues: v20 (ref) ]]
	return v20
end
function t.getPanning() --[[ getPanning | Line: 503 | Upvalues: v20 (ref), v19 (ref) ]]
	return v20 or v19
end
function t.setTogglePan(p1) --[[ setTogglePan | Line: 507 | Upvalues: v20 (ref) ]]
	v20 = p1
end
local v22 = false
local v23 = nil
local v24 = nil
function t.enableCameraToggleInput() --[[ enableCameraToggleInput | Line: 515 | Upvalues: v22 (ref), v19 (ref), v20 (ref), v23 (ref), v24 (ref), v10 (ref), v21 (ref), v11 (ref), UserInputService (copy) ]]
	if v22 then
		return
	end
	v22 = true
	...
	v23 = v10:Connect(function() --[[ Line: 532 | Upvalues: v19 (ref), v21 (ref) ]]
		v19 = true
		v21 = tick()
	end)
	v24 = v11:Connect(function() --[[ Line: 537 | Upvalues: v19 (ref), v21 (ref), v20 (ref), UserInputService (ref) ]]
		v19 = false
...
function t.disableCameraToggleInput() --[[ disableCameraToggleInput | Line: 545 | Upvalues: v22 (ref), v23 (ref), v24 (ref) ]]
	if not v22 then
		return
	end
	v22 = false
