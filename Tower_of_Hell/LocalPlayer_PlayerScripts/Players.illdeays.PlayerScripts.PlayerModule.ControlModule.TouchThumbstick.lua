...
v1.__index = v1
function v1.new() --[[ new | Line: 17 | Upvalues: BaseCharacterController (copy), v1 (copy) ]]
...
function v1.Enable(p1, p2, p3) --[[ Enable | Line: 32 ]]
	if p2 == nil then
		return false
	end
...
function v1.OnInputEnded(p1) --[[ OnInputEnded | Line: 53 ]]
...
function v1.Create(p1, p2) --[[ Create | Line: 62 | Upvalues: UserInputService (copy), GuiService (copy) ]]
	...
	local v4 = nil
	local function DoMove(p12) --[[ DoMove | Line: 115 | Upvalues: p1 (copy) ]]
	...
	local function MoveStick(p12) --[[ MoveStick | Line: 133 | Upvalues: v4 (ref), p1 (copy) ]]
	...
	p1.thumbstickFrame.InputBegan:Connect(function(p12) --[[ Line: 150 | Upvalues: p1 (copy), v4 (ref) ]]
	...
	p1.onTouchMovedConn = UserInputService.TouchMoved:Connect(function(p12, p2) --[[ Line: 165 | Upvalues: p1 (copy), v4 (ref), MoveStick (copy) ]]
	...
	p1.onTouchEndedConn = UserInputService.TouchEnded:Connect(function(p12, p2) --[[ Line: 175 | Upvalues: p1 (copy) ]]
		if p12 ~= p1.moveTouchObject then
			return
		end
		p1:OnInputEnded()
	end)
	GuiService.MenuOpened:Connect(function() --[[ Line: 181 | Upvalues: p1 (copy) ]]
