...
v1.__index = v1
function v1.new(p1) --[[ new | Line: 19 | Upvalues: BaseCharacterController (copy), v1 (copy) ]]
...
function v1.Enable(p1, p2) --[[ Enable | Line: 38 | Upvalues: UserInputService (copy) ]]
...
function v1.UpdateMovement(p1, p2) --[[ UpdateMovement | Line: 70 ]]
...
function v1.UpdateJump(p1) --[[ UpdateJump | Line: 78 ]]
	p1.isJumping = p1.jumpRequested
end
function v1.BindContextActions(p1) --[[ BindContextActions | Line: 82 | Upvalues: ContextActionService (copy) ]]
	ContextActionService:BindActionAtPriority("moveForwardAction", function(p12, p2, p3) --[[ Line: 88 | Upvalues: p1 (copy) ]]
	...
	ContextActionService:BindActionAtPriority("moveBackwardAction", function(p12, p2, p3) --[[ Line: 94 | Upvalues: p1 (copy) ]]
	...
	ContextActionService:BindActionAtPriority("moveLeftAction", function(p12, p2, p3) --[[ Line: 100 | Upvalues: p1 (copy) ]]
	...
	ContextActionService:BindActionAtPriority("moveRightAction", function(p12, p2, p3) --[[ Line: 106 | Upvalues: p1 (copy) ]]
	...
	ContextActionService:BindActionAtPriority("jumpAction", function(p12, p2, p3) --[[ Line: 112 | Upvalues: p1 (copy) ]]
...
function v1.UnbindContextActions(p1) --[[ UnbindContextActions | Line: 132 | Upvalues: ContextActionService (copy) ]]
...
function v1.ConnectFocusEventListeners(p1) --[[ ConnectFocusEventListeners | Line: 140 | Upvalues: UserInputService (copy) ]]
	local function onFocusReleased() --[[ onFocusReleased | Line: 141 | Upvalues: p1 (copy) ]]
		p1.moveVector = Vector3.new(0, 0, 0)
		p1.forwardValue = 0
		p1.backwardValue = 0
		p1.leftValue = 0
	...
	local function onTextFocusGained(p12) --[[ onTextFocusGained | Line: 151 | Upvalues: p1 (copy) ]]
		p1.jumpRequested = false
		p1:UpdateJump()
	end
...
function v1.DisconnectFocusEventListeners(p1) --[[ DisconnectFocusEventListeners | Line: 161 ]]
