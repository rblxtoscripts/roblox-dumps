...
local function getYaw(p1) --[[ getYaw | Line: 9 | Upvalues: sanitizeAngle (copy) ]]
	local _, v1 = p1:toEulerAnglesYXZ()
	return sanitizeAngle(v1)
end
local function getPitch(p1) --[[ getPitch | Line: 15 | Upvalues: sanitizeAngle (copy) ]]
	return sanitizeAngle((p1:toEulerAnglesYXZ()))
end
local function stepSpringAxis(p1, p2, p3, p4, p5) --[[ stepSpringAxis | Line: 21 | Upvalues: sanitizeAngle (copy) ]]
...
local t = {}
t.__index = t
function t.new(p1, p2, p3) --[[ new | Line: 35 | Upvalues: t (copy) ]]
	return setmetatable({
		fRising = p1,
		fFalling = p2,
		g = p3,
...
function t.step(p1, p2) --[[ step | Line: 45 ]]
...
local t2 = {}
t2.__index = t2
function t2.new(p1) --[[ new | Line: 71 | Upvalues: sanitizeAngle (copy), t (copy), VehicleCameraConfig (copy), t2 (copy) ]]
...
function t2.setGoal(p1, p2) --[[ setGoal | Line: 98 | Upvalues: sanitizeAngle (copy) ]]
...
function t2.getCFrame(p1) --[[ getCFrame | Line: 105 ]]
	return CFrame.fromEulerAnglesYXZ(p1.pitchP, p1.yawP, 0)
end
function t2.step(p1, p2, p3, p4, p5) --[[ step | Line: 109 | Upvalues: mapClamp (copy), map (copy), VehicleCameraConfig (copy), sanitizeAngle (copy) ]]
...
local t3 = {}
t3.__index = t3
function t3.new(p1) --[[ new | Line: 166 | Upvalues: t2 (copy), t3 (copy) ]]
	return setmetatable({
		vrs = t2.new(p1)
	}, t3)
end
function t3.step(p1, p2, p3, p4, p5) --[[ step | Line: 172 ]]
	return p1.vrs:step(p2, p3, p4, p5)
end
function t3.setTransform(p1, p2) --[[ setTransform | Line: 176 ]]
	p1.vrs:setGoal(p2)
end
return t3