...
local function CreateWaypointTemplates() --[[ CreateWaypointTemplates | Line: 43 | Upvalues: v10 (ref), v3 (ref), v1 (ref), v4 (copy), v5 (copy), v2 (ref), v7 (copy) ]]
...
local function getTrailDotParent() --[[ getTrailDotParent | Line: 129 | Upvalues: Workspace (copy) ]]
...
local function placePathWaypoint(p1, p2) --[[ placePathWaypoint | Line: 140 | Upvalues: Workspace (copy), LocalPlayer (copy) ]]
...
local t2 = {}
t2.__index = t2
function t2.Destroy(p1) --[[ Destroy | Line: 155 ]]
	p1.DisplayModel:Destroy()
end
function t2.NewDisplayModel(p1, p2) --[[ NewDisplayModel | Line: 159 | Upvalues: v11 (ref), placePathWaypoint (copy) ]]
	local v1 = v11:Clone()
	placePathWaypoint(v1, p2)
	return v1
end
function t2.new(p1, p2) --[[ new | Line: 165 | Upvalues: t2 (copy) ]]
...
local t3 = {}
t3.__index = t3
function t3.Destroy(p1) --[[ Destroy | Line: 177 ]]
	p1.Destroyed = true
	p1.Tween:Cancel()
	p1.DisplayModel:Destroy()
end
function t3.NewDisplayModel(p1, p2) --[[ NewDisplayModel | Line: 183 | Upvalues: v12 (ref), placePathWaypoint (copy) ]]
	local v1 = v12:Clone()
	placePathWaypoint(v1, p2)
	return v1
end
function t3.CreateTween(p1) --[[ CreateTween | Line: 189 | Upvalues: TweenService (copy), v6 (copy) ]]
...
function t3.TweenInFrom(p1, p2) --[[ TweenInFrom | Line: 200 | Upvalues: TweenService (copy) ]]
...
function t3.new(p1, p2, p3) --[[ new | Line: 214 | Upvalues: t3 (copy) ]]
	local v2 = setmetatable({}, t3)
	v2.DisplayModel = v2:NewDisplayModel(p1)
	v2.Destroyed = false
	if p3 and (p3 - p1).magnitude > 5 then
		v2.Tween = v2:TweenInFrom(p3)
		coroutine.wrap(function() --[[ Line: 221 | Upvalues: v2 (copy) ]]
...
local t4 = {}
t4.__index = t4
function t4.Hide(p1) --[[ Hide | Line: 238 ]]
	p1.DisplayModel.Parent = nil
end
function t4.Destroy(p1) --[[ Destroy | Line: 242 ]]
	p1.DisplayModel:Destroy()
end
function t4.NewDisplayModel(p1, p2) --[[ NewDisplayModel | Line: 246 | Upvalues: v13 (ref), placePathWaypoint (copy), Workspace (copy), LocalPlayer (copy) ]]
	local v1 = v13:Clone()
	placePathWaypoint(v1, p2)
...
function t4.RunFailureTween(p1) --[[ RunFailureTween | Line: 260 | Upvalues: TweenService (copy), v8 (copy), v9 (copy), v7 (copy) ]]
	wait(0.125)
...
function t4.new(p1) --[[ new | Line: 309 | Upvalues: t4 (copy) ]]
...
local v14 = nil
local function getFailureAnimationTrack(p1) --[[ getFailureAnimationTrack | Line: 323 | Upvalues: v14 (ref), Animation (copy) ]]
	if p1 ~= nil then
...
local function findPlayerHumanoid() --[[ findPlayerHumanoid | Line: 333 | Upvalues: LocalPlayer (copy) ]]
	local Character = LocalPlayer.Character
	if Character then
		return Character:FindFirstChildOfClass("Humanoid")
	end
end
local function createTrailDots(p1, p2) --[[ createTrailDots | Line: 340 | Upvalues: t2 (copy), t3 (copy) ]]
	local t = {}
	local count = 1
	for i = 1, #p1 - 1 do
...
local function getTrailDotScale(p1, p2) --[[ getTrailDotScale | Line: 365 ]]
	return p2 * (math.clamp(p1 - 10, 0, 90) / 90 * 1.5 + 1)
end
local v15 = 0
function t.CreatePathDisplay(p1, p2) --[[ CreatePathDisplay | Line: 374 | Upvalues: v15 (ref), createTrailDots (copy), RunService (copy), Workspace (copy), v10 (ref) ]]
	v15 = v15 + 1
	local v1 = createTrailDots(p1, p2)
	local function removePathBeforePoint(p1) --[[ removePathBeforePoint | Line: 378 | Upvalues: v1 (copy) ]]
		for i = #v1, 1, -1 do
			local v12 = v1[i]
	...
	local function resizeTrailDots() --[[ resizeTrailDots | Line: 392 | Upvalues: v1 (copy), RunService (ref), v2 (copy), Workspace (ref), v10 (ref) ]]
		if #v1 == 0 then
	...
	return function() --[[ removePath | Line: 408 | Upvalues: removePathBeforePoint (copy), p1 (copy) ]]
		removePathBeforePoint(#p1)
	end, removePathBeforePoint
end
local v16 = nil
function t.DisplayFailureWaypoint(p1) --[[ DisplayFailureWaypoint | Line: 416 | Upvalues: v16 (ref), t4 (copy) ]]
	local v1
	if not v16 then
		v1 = t4.new(p1)
		v16 = v1
		coroutine.wrap(function() --[[ Line: 422 | Upvalues: v1 (ref) ]]
			v1:RunFailureTween()
			v1:Destroy()
			v1 = nil
		end)()
...
function t.CreateEndWaypoint(p1) --[[ CreateEndWaypoint | Line: 429 | Upvalues: t3 (copy) ]]
	return t3.new(p1)
end
function t.PlayFailureAnimation() --[[ PlayFailureAnimation | Line: 433 | Upvalues: LocalPlayer (copy), v14 (ref), Animation (copy) ]]
	local Character = LocalPlayer.Character
...
function t.CancelFailureAnimation() --[[ CancelFailureAnimation | Line: 441 | Upvalues: v14 (ref) ]]
	if v14 == nil or not v14.IsPlaying then
		return
	end
	v14:Stop()
end
function t.SetWaypointTexture(p1) --[[ SetWaypointTexture | Line: 447 | Upvalues: v1 (ref), v11 (ref), v12 (ref), v13 (ref), CreateWaypointTemplates (copy) ]]
	v1 = p1
...
function t.GetWaypointTexture() --[[ GetWaypointTexture | Line: 452 | Upvalues: v1 (ref) ]]
	return v1
end
function t.SetWaypointRadius(p1) --[[ SetWaypointRadius | Line: 456 | Upvalues: v10 (ref), v11 (ref), v12 (ref), v13 (ref), CreateWaypointTemplates (copy) ]]
...
function t.GetWaypointRadius() --[[ GetWaypointRadius | Line: 461 | Upvalues: v10 (ref) ]]
	return v10.X
end
function t.SetEndWaypointTexture(p1) --[[ SetEndWaypointTexture | Line: 465 | Upvalues: v2 (ref), v11 (ref), v12 (ref), v13 (ref), CreateWaypointTemplates (copy) ]]
	v2 = p1
...
function t.GetEndWaypointTexture() --[[ GetEndWaypointTexture | Line: 470 | Upvalues: v2 (ref) ]]
	return v2
end
function t.SetWaypointsAlwaysOnTop(p1) --[[ SetWaypointsAlwaysOnTop | Line: 474 | Upvalues: v3 (ref), v11 (ref), v12 (ref), v13 (ref), CreateWaypointTemplates (copy) ]]
	v3 = p1
...
function t.GetWaypointsAlwaysOnTop() --[[ GetWaypointsAlwaysOnTop | Line: 479 | Upvalues: v3 (ref) ]]
	return v3
end
return t