...
v1.__index = v1
function v1.new(p1) --[[ new | Line: 20 | Upvalues: BaseCharacterController (copy), v1 (copy), None (copy) ]]
...
function v1.Enable(p1, p2) --[[ Enable | Line: 36 | Upvalues: UserInputService (copy), None (copy) ]]
...
function v1.GetHighestPriorityGamepad(p1) --[[ GetHighestPriorityGamepad | Line: 76 | Upvalues: UserInputService (copy), None (copy) ]]
	local v2 = None
...
function v1.BindContextActions(p1) --[[ BindContextActions | Line: 87 | Upvalues: None (copy), ContextActionService (copy) ]]
	if p1.activeGamepad == None then
		return false
	else
		ContextActionService:BindActivate(p1.activeGamepad, Enum.KeyCode.ButtonR2)
		ContextActionService:BindActionAtPriority("jumpAction", function(p12, p2, p3) --[[ Line: 94 | Upvalues: p1 (copy) ]]
			p1.isJumping = p2 == Enum.UserInputState.Begin
			return Enum.ContextActionResult.Pass
		end, false, p1.CONTROL_ACTION_PRIORITY, Enum.KeyCode.ButtonA)
		ContextActionService:BindActionAtPriority("moveThumbstick", function(p12, p2, p3) --[[ Line: 99 | Upvalues: p1 (copy) ]]
			if _G.StopThumbstick then
				return
			end
...
function v1.UnbindContextActions(p1) --[[ UnbindContextActions | Line: 129 | Upvalues: None (copy), ContextActionService (copy) ]]
	if p1.activeGamepad == None then
...
function v1.OnNewGamepadConnected(p1) --[[ OnNewGamepadConnected | Line: 137 | Upvalues: None (copy) ]]
...
function v1.OnCurrentGamepadDisconnected(p1) --[[ OnCurrentGamepadDisconnected | Line: 164 | Upvalues: None (copy), ContextActionService (copy) ]]
	if p1.activeGamepad ~= None then
		ContextActionService:UnbindActivate(p1.activeGamepad, Enum.KeyCode.ButtonR2)
	end
	local v1 = p1:GetHighestPriorityGamepad()
...
function v1.ConnectGamepadConnectionListeners(p1) --[[ ConnectGamepadConnectionListeners | Line: 189 | Upvalues: UserInputService (copy) ]]
	p1.gamepadConnectedConn = UserInputService.GamepadConnected:Connect(function(p12) --[[ Line: 190 | Upvalues: p1 (copy) ]]
		p1:OnNewGamepadConnected()
	end)
	p1.gamepadDisconnectedConn = UserInputService.GamepadDisconnected:Connect(function(p12) --[[ Line: 194 | Upvalues: p1 (copy) ]]
...
function v1.DisconnectGamepadConnectionListeners(p1) --[[ DisconnectGamepadConnectionListeners | Line: 202 ]]
