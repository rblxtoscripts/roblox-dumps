...
assert(LocalPlayer)
local function updateBounds() --[[ updateBounds | Line: 24 | Upvalues: v1 (ref), LocalPlayer (copy), v2 (ref) ]]
...
local t = {}
t.__index = t
function t.new(p1, p2, p3, p4) --[[ new | Line: 38 | Upvalues: clamp (copy), t (copy) ]]
...
function t.Step(p1, p2) --[[ Step | Line: 50 | Upvalues: exp (copy) ]]
...
local function stepTargetZoom(p1, p2, p3, p4) --[[ stepTargetZoom | Line: 88 | Upvalues: clamp (copy) ]]
	local v1 = clamp(p1 + p2 * (p1 * 0.0375 + 1), p3, p4)
	return if v1 < 1 then if p2 <= 0 and p3 then p3 else 1 else v1
end
local v4 = 0
return {
	Update = function(p1, p2, p3) --[[ Update | Line: 99 | Upvalues: v3 (copy), v4 (ref), v1 (ref), v2 (ref), clamp (copy), max (copy), Popper (copy), min (copy) ]]
		local v12
		if v3.goal > 1 then
			local goal = v3.goal
			local v22 = v4
	...
	GetZoomRadius = function() --[[ GetZoomRadius | Line: 123 | Upvalues: v3 (copy) ]]
		return v3.x
	end,
	SetZoomParameters = function(p1, p2) --[[ SetZoomParameters | Line: 127 | Upvalues: v3 (copy), v4 (ref) ]]
		v3.goal = p1
		v4 = p2
	end,
	ReleaseSpring = function() --[[ ReleaseSpring | Line: 132 | Upvalues: v3 (copy) ]]
		v3.x = v3.goal
		v3.v = 0
	end
}