...
local t = {}
t.__index = t
function t.new(p1) --[[ new | Line: 26 | Upvalues: t (copy) ]]
...
function t.BindContextActions(p1) --[[ BindContextActions | Line: 50 | Upvalues: ContextActionService (copy) ]]
	ContextActionService:BindActionAtPriority("throttleAccel", function(p12, p2, p3) --[[ Line: 52 | Upvalues: p1 (copy) ]]
		p1:OnThrottleAccel(p12, p2, p3)
		return Enum.ContextActionResult.Pass
	end, false, p1.CONTROL_ACTION_PRIORITY, Enum.KeyCode.ButtonR2)
	ContextActionService:BindActionAtPriority("throttleDeccel", function(p12, p2, p3) --[[ Line: 56 | Upvalues: p1 (copy) ]]
		p1:OnThrottleDeccel(p12, p2, p3)
		return Enum.ContextActionResult.Pass
	end, false, p1.CONTROL_ACTION_PRIORITY, Enum.KeyCode.ButtonL2)
	ContextActionService:BindActionAtPriority("arrowSteerRight", function(p12, p2, p3) --[[ Line: 61 | Upvalues: p1 (copy) ]]
		p1:OnSteerRight(p12, p2, p3)
		return Enum.ContextActionResult.Pass
	end, false, p1.CONTROL_ACTION_PRIORITY, Enum.KeyCode.Right)
	ContextActionService:BindActionAtPriority("arrowSteerLeft", function(p12, p2, p3) --[[ Line: 65 | Upvalues: p1 (copy) ]]
		p1:OnSteerLeft(p12, p2, p3)
		return Enum.ContextActionResult.Pass
	end, false, p1.CONTROL_ACTION_PRIORITY, Enum.KeyCode.Left)
end
function t.Enable(p1, p2, p3) --[[ Enable | Line: 71 | Upvalues: ContextActionService (copy) ]]
...
function t.OnThrottleAccel(p1, p2, p3, p4) --[[ OnThrottleAccel | Line: 97 ]]
...
function t.OnThrottleDeccel(p1, p2, p3, p4) --[[ OnThrottleDeccel | Line: 106 ]]
	if p3 == Enum.UserInputState.End or p3 == Enum.UserInputState.Cancel then
		p1.decceleration = 0
	else
		p1.decceleration = 1
...
function t.OnSteerRight(p1, p2, p3, p4) --[[ OnSteerRight | Line: 115 ]]
	if p3 == Enum.UserInputState.End or p3 == Enum.UserInputState.Cancel then
		p1.turningRight = 0
	else
		p1.turningRight = 1
...
function t.OnSteerLeft(p1, p2, p3, p4) --[[ OnSteerLeft | Line: 124 ]]
	if p3 == Enum.UserInputState.End or p3 == Enum.UserInputState.Cancel then
		p1.turningLeft = 0
	else
		p1.turningLeft = -1
...
function t.Update(p1, p2, p3, p4) --[[ Update | Line: 134 ]]
...
function t.ComputeThrottle(p1, p2) --[[ ComputeThrottle | Line: 160 ]]
...
function t.ComputeSteer(p1, p2) --[[ ComputeSteer | Line: 169 ]]
	if p2 == Vector3.new(0, 0, 0) then
		return 0
	else
...
function t.SetupAutoPilot(p1) --[[ SetupAutoPilot | Line: 178 ]]
