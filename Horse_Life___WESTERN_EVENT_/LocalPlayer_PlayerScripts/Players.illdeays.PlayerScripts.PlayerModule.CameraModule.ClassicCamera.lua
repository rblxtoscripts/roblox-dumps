...
Vector2.new(0, 0)
local v1 = 0
local v2 = CFrame.fromOrientation(-0.4363323129985824, 0, 0)
...
v3.__index = v3
function v3.new() --[[ new | Line: 33 | Upvalues: BaseCamera (copy), v3 (copy), CameraUtils (copy) ]]
...
function v3.GetCameraToggleOffset(p1, p2) --[[ GetCameraToggleOffset | Line: 44 | Upvalues: CameraInput (copy), CameraUtils (copy) ]]
...
function v3.SetCameraMovementMode(p1, p2) --[[ SetCameraMovementMode | Line: 62 | Upvalues: BaseCamera (copy) ]]
...
function v3.Update(p1) --[[ Update | Line: 69 | Upvalues: v2 (copy), Players (copy), CameraInput (copy), v1 (ref), CameraUtils (copy), VRService (copy) ]]
	local v12 = tick()
...
function v3.EnterFirstPerson(p1) --[[ EnterFirstPerson | Line: 243 ]]
	p1.inFirstPerson = true
	p1:UpdateMouseBehavior()
end
function v3.LeaveFirstPerson(p1) --[[ LeaveFirstPerson | Line: 248 ]]
