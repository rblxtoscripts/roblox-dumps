...
local function IsFinite(p1) --[[ IsFinite | Line: 31 ]]
	return if p1 == p1 and p1 ~= (1 / 0) then p1 ~= (-1 / 0) else false
end
local function IsFiniteVector3(p1) --[[ IsFiniteVector3 | Line: 35 ]]
	local x = p1.x
...
coroutine.wrap(function() --[[ Line: 43 | Upvalues: v1 (ref) ]]
...
v2.__index = v2
function v2.new(p1) --[[ new | Line: 56 | Upvalues: BaseCharacterController (copy), v2 (copy) ]]
...
function v2.SetLaserPointerMode(p1, p2) --[[ SetLaserPointerMode | Line: 81 | Upvalues: StarterGui (copy) ]]
	pcall(function() --[[ Line: 82 | Upvalues: StarterGui (ref), p2 (copy) ]]
		StarterGui:SetCore("VRLaserPointerMode", p2)
	end)
end
function v2.GetLocalHumanoid(p1) --[[ GetLocalHumanoid | Line: 87 | Upvalues: LocalPlayer (copy) ]]
...
function v2.HasBothHandControllers(p1) --[[ HasBothHandControllers | Line: 101 | Upvalues: VRService (copy) ]]
...
function v2.HasAnyHandControllers(p1) --[[ HasAnyHandControllers | Line: 105 | Upvalues: VRService (copy) ]]
...
function v2.IsMobileVR(p1) --[[ IsMobileVR | Line: 109 | Upvalues: UserInputService (copy) ]]
	return UserInputService.TouchEnabled
end
function v2.HasGamepad(p1) --[[ HasGamepad | Line: 113 | Upvalues: UserInputService (copy) ]]
	return UserInputService.GamepadEnabled
end
function v2.ShouldUseNavigationLaser(p1) --[[ ShouldUseNavigationLaser | Line: 117 ]]
...
function v2.StartFollowingPath(p1, p2) --[[ StartFollowingPath | Line: 139 | Upvalues: MovementUpdate (copy) ]]
	currentPath = p2
...
function v2.GoToPoint(p1, p2) --[[ GoToPoint | Line: 156 | Upvalues: MovementUpdate (copy) ]]
	currentPath = true
	currentPoints = { p2 }
	currentPointIdx = 1
	moving = true
...
function v2.StopFollowingPath(p1) --[[ StopFollowingPath | Line: 172 ]]
	currentPath = nil
	currentPoints = nil
	currentPointIdx = 0
	moving = false
...
function v2.TryComputePath(p1, p2, p3) --[[ TryComputePath | Line: 180 | Upvalues: PathfindingService (copy) ]]
	local v1 = nil
	local count = 0
...
function v2.OnNavigationRequest(p1, p2, p3) --[[ OnNavigationRequest | Line: 207 | Upvalues: v1 (ref) ]]
...
function v2.OnJumpAction(p1, p2, p3, p4) --[[ OnJumpAction | Line: 253 ]]
...
function v2.BindJumpAction(p1, p2) --[[ BindJumpAction | Line: 259 | Upvalues: ContextActionService (copy) ]]
	if p2 then
		if not p1.isJumpBound then
			p1.isJumpBound = true
			ContextActionService:BindActionAtPriority("VRJumpAction", function() --[[ Line: 263 | Upvalues: p1 (copy) ]]
...
function v2.ControlCharacterGamepad(p1, p2, p3, p4) --[[ ControlCharacterGamepad | Line: 274 | Upvalues: v1 (ref), MovementUpdate (copy) ]]
...
function v2.OnHeartbeat(p1, p2) --[[ OnHeartbeat | Line: 317 | Upvalues: v1 (ref), MovementUpdate (copy) ]]
...
function v2.OnUserCFrameEnabled(p1) --[[ OnUserCFrameEnabled | Line: 401 ]]
	if p1:ShouldUseNavigationLaser() then
		p1:BindJumpAction(false)
		p1:SetLaserPointerMode("Navigation")
	else
...
function v2.Enable(p1, p2) --[[ Enable | Line: 411 | Upvalues: VRService (copy), RunService (copy), ContextActionService (copy) ]]
	p1.moveVector = Vector3.new(0, 0, 0)
	p1.isJumping = false
	if p2 then
		p1.navigationRequestedConn = VRService.NavigationRequested:Connect(function(p12, p2) --[[ Line: 417 | Upvalues: p1 (copy) ]]
			p1:OnNavigationRequest(p12, p2)
		end)
		p1.heartbeatConn = RunService.Heartbeat:Connect(function(p12) --[[ Line: 418 | Upvalues: p1 (copy) ]]
			p1:OnHeartbeat(p12)
		end)
		ContextActionService:BindAction("MoveThumbstick", function(p12, p2, p3) --[[ Line: 420 | Upvalues: p1 (copy) ]]
			return p1:ControlCharacterGamepad(p12, p2, p3)
		end, false, p1.CONTROL_ACTION_PRIORITY, Enum.KeyCode.Thumbstick1)
		ContextActionService:BindActivate(Enum.UserInputType.Gamepad1, Enum.KeyCode.ButtonR2)
		p1.userCFrameEnabledConn = VRService.UserCFrameEnabled:Connect(function() --[[ Line: 424 | Upvalues: p1 (copy) ]]
