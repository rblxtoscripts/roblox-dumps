...
v1.__index = v1
function v1.new() --[[ new | Line: 19 | Upvalues: BaseCharacterController (copy), v1 (copy) ]]
...
function v1.EnableButton(p1, p2) --[[ EnableButton | Line: 37 | Upvalues: Players (copy) ]]
	if p2 then
...
function v1.UpdateEnabled(p1) --[[ UpdateEnabled | Line: 57 ]]
...
function v1.HumanoidChanged(p1, p2) --[[ HumanoidChanged | Line: 65 | Upvalues: Players (copy) ]]
	local v1 = Players.LocalPlayer.Character and Players.LocalPlayer.Character:FindFirstChildOfClass("Humanoid")
	if not v1 then
		return
	end
...
function v1.HumanoidStateEnabledChanged(p1, p2, p3) --[[ HumanoidStateEnabledChanged | Line: 79 ]]
...
function v1.CharacterAdded(p1, p2) --[[ CharacterAdded | Line: 86 ]]
	...
	p1.humanoidJumpPowerConn = p1.humanoid:GetPropertyChangedSignal("JumpPower"):Connect(function() --[[ Line: 98 | Upvalues: p1 (copy) ]]
		p1.jumpPower = p1.humanoid.JumpPower
		p1:UpdateEnabled()
	end)
	p1.humanoidParentConn = p1.humanoid:GetPropertyChangedSignal("Parent"):Connect(function() --[[ Line: 103 | Upvalues: p1 (copy) ]]
	...
	p1.humanoidStateEnabledChangedConn = p1.humanoid.StateEnabledChanged:Connect(function(p12, p2) --[[ Line: 112 | Upvalues: p1 (copy) ]]
...
function v1.SetupCharacterAddedFunction(p1) --[[ SetupCharacterAddedFunction | Line: 121 | Upvalues: Players (copy) ]]
	p1.characterAddedConn = Players.LocalPlayer.CharacterAdded:Connect(function(p12) --[[ Line: 122 | Upvalues: p1 (copy) ]]
...
function v1.Enable(p1, p2, p3) --[[ Enable | Line: 130 ]]
	if p3 then
		p1.parentUIFrame = p3
	end
...
function v1.Create(p1) --[[ Create | Line: 138 | Upvalues: GuiService (copy) ]]
	...
	local v4 = nil
	p1.jumpButton.InputBegan:connect(function(p12) --[[ Line: 165 | Upvalues: v4 (ref), p1 (copy) ]]
	...
	p1.jumpButton.InputEnded:connect(function(p12) --[[ Line: 184 | Upvalues: v4 (ref), p1 (copy) ]]
		if p12 ~= v4 then
			return
		end
		v4 = nil
	...
	GuiService.MenuOpened:connect(function() --[[ Line: 190 | Upvalues: v4 (ref), p1 (copy) ]]
		if not v4 then
			return
		end
		v4 = nil
