...
local v3 = v1 and v2
local v4, v5 = pcall(function() --[[ Line: 13 ]]
	return UserSettings():IsUserFeatureEnabled("UserClickToMoveSupportAgentCanClimb")
end)
local v6 = v4 and v5
...
local t2 = {}
local function v12(p1) --[[ FindCharacterAncestor | Line: 55 | Upvalues: v12 (copy) ]]
	if not p1 then
		return
	end
...
local function v13(p1, p2, p3) --[[ Raycast | Line: 67 | Upvalues: Workspace (copy), v12 (copy), v13 (copy) ]]
...
t2.Raycast = v13
local t3 = {}
local function findPlayerHumanoid(p1) --[[ findPlayerHumanoid | Line: 88 | Upvalues: t3 (copy) ]]
...
local v16 = nil
local v17 = nil
local function GetCharacter() --[[ GetCharacter | Line: 112 | Upvalues: LocalPlayer (copy) ]]
	return LocalPlayer and LocalPlayer.Character
end
local function UpdateIgnoreTag(p1) --[[ UpdateIgnoreTag | Line: 116 | Upvalues: v15 (ref), v16 (ref), v17 (ref), v14 (ref), LocalPlayer (copy), CollectionService (copy) ]]
	if p1 == v15 then
		return
	end
	if v16 then
	...
	v16 = CollectionService:GetInstanceAddedSignal(p1):Connect(function(p1) --[[ Line: 136 | Upvalues: v14 (ref) ]]
		table.insert(v14, p1)
	end)
	v17 = CollectionService:GetInstanceRemovedSignal(p1):Connect(function(p1) --[[ Line: 140 | Upvalues: v14 (ref) ]]
		for i = 1, #v14 do
			if v14[i] == p1 then
				v14[i] = v14[#v14]
				table.remove(v14)
...
local function getIgnoreList() --[[ getIgnoreList | Line: 152 | Upvalues: v14 (ref), LocalPlayer (copy) ]]
	if v14 then
		return v14
	end
	v14 = {}
...
local function minV(p1, p2) --[[ minV | Line: 161 ]]
	return Vector3.new(math.min(p1.X, p2.X), math.min(p1.Y, p2.Y), (math.min(p1.Z, p2.Z)))
end
local function maxV(p1, p2) --[[ maxV | Line: 164 ]]
	return Vector3.new(math.max(p1.X, p2.X), math.max(p1.Y, p2.Y), (math.max(p1.Z, p2.Z)))
end
local function getCollidableExtentsSize(p1) --[[ getCollidableExtentsSize | Line: 167 ]]
...
local function Pather(p1, p2, p3) --[[ Pather | Line: 200 | Upvalues: v9 (ref), LocalPlayer (copy), t3 (copy), v10 (ref), v3 (copy), getCollidableExtentsSize (copy), v6 (copy), PathfindingService (copy), v7 (ref), ClickToMoveDisplay (copy), v11 (ref), Workspace (copy), v14 (ref) ]]
	local t = {}
	local v1, v2
	if p3 == nil then
		v1 = v9
	...
	function t.Cleanup(p1) --[[ Cleanup | Line: 313 | Upvalues: t (copy) ]]
		if t.stopTraverseFunc then
			t.stopTraverseFunc()
			t.stopTraverseFunc = nil
		end
		if t.MoveToConn then
			t.MoveToConn:Disconnect()
			t.MoveToConn = nil
		end
	...
	function t.Cancel(p1) --[[ Cancel | Line: 347 | Upvalues: t (copy) ]]
		t.Cancelled = true
		t:Cleanup()
	end
	function t.IsActive(p1) --[[ IsActive | Line: 352 | Upvalues: t (copy) ]]
		return t.AgentCanFollowPath and (t.Started and not t.Cancelled)
	end
	function t.OnPathInterrupted(p1) --[[ OnPathInterrupted | Line: 356 | Upvalues: t (copy) ]]
		t.Cancelled = true
		t:OnPointReached(false)
	end
	function t.ComputePath(p1) --[[ ComputePath | Line: 362 | Upvalues: t (copy) ]]
		...
		if t.AgentCanFollowPath then
			if t.DirectPath then
				...
				t.BlockedConn = t.pathResult.Blocked:Connect(function(p1) --[[ Line: 376 | Upvalues: t (ref) ]]
					t:OnPathBlocked(p1)
				end)
				local v5 = t
	...
	function t.IsValidPath(p1) --[[ IsValidPath | Line: 384 | Upvalues: t (copy) ]]
		t:ComputePath()
		return t.PathComputed and t.AgentCanFollowPath
	end
	t.Recomputing = false
	function t.OnPathBlocked(p1, p2) --[[ OnPathBlocked | Line: 390 | Upvalues: t (copy), v7 (ref), ClickToMoveDisplay (ref) ]]
	...
	function t.OnRenderStepped(p1, p2) --[[ OnRenderStepped | Line: 426 | Upvalues: t (copy), v11 (ref) ]]
	...
	function t.IsCurrentWaypointReached(p1) --[[ IsCurrentWaypointReached | Line: 464 | Upvalues: t (copy) ]]
		local v1
	...
	function t.OnPointReached(p1, p2) --[[ OnPointReached | Line: 490 | Upvalues: t (copy) ]]
	...
	function t.MoveToNextWayPoint(p1, p2, p3, p4) --[[ MoveToNextWayPoint | Line: 553 | Upvalues: t (copy) ]]
	...
	function t.Start(p1, p2) --[[ Start | Line: 581 | Upvalues: t (copy), ClickToMoveDisplay (ref), v7 (ref) ]]
		...
		if #t.pointList > 0 then
			...
			t.CurrentHumanoidPosition = t.Humanoid.RootPart.Position + t.HumanoidOffsetFromPath
			t.CurrentHumanoidVelocity = t.Humanoid.RootPart.Velocity
			t.SeatedConn = t.Humanoid.Seated:Connect(function(p1, p2) --[[ Line: 608 | Upvalues: t (ref) ]]
				t:OnPathInterrupted()
			end)
			t.DiedConn = t.Humanoid.Died:Connect(function() --[[ Line: 609 | Upvalues: t (ref) ]]
				t:OnPathInterrupted()
			end)
			t.TeleportedConn = t.Humanoid.RootPart:GetPropertyChangedSignal("CFrame"):Connect(function() --[[ Line: 610 | Upvalues: t (ref) ]]
				t:OnPathInterrupted()
			end)
			t.CurrentPoint = 1
			t:OnPointReached(true)
...
local function CheckAlive() --[[ CheckAlive | Line: 637 | Upvalues: LocalPlayer (copy), t3 (copy) ]]
...
local function GetEquippedTool(p1) --[[ GetEquippedTool | Line: 642 ]]
	if p1 == nil then
		return
	end
...
local v19 = nil
local v20 = nil
local function CleanupPath() --[[ CleanupPath | Line: 657 | Upvalues: v18 (ref), v19 (ref), v20 (ref) ]]
	if v18 then
		v18:Cancel()
		v18 = nil
	end
...
local function HandleMoveTo(p1, p2, p3, p4, p5) --[[ HandleMoveTo | Line: 675 | Upvalues: v18 (ref), v19 (ref), v20 (ref), GetEquippedTool (copy), v8 (ref), ClickToMoveDisplay (copy) ]]
	if v18 then
		if v18 then
			v18:Cancel()
			v18 = nil
	...
	v18 = p1
	p1:Start(p5)
	v19 = p1.Finished.Event:Connect(function() --[[ Line: 682 | Upvalues: v18 (ref), v19 (ref), v20 (ref), p3 (copy), GetEquippedTool (ref), p4 (copy) ]]
		if v18 then
			v18:Cancel()
			v18 = nil
		end
	...
	v20 = p1.PathFailed.Event:Connect(function() --[[ Line: 691 | Upvalues: v18 (ref), v19 (ref), v20 (ref), p5 (copy), v8 (ref), ClickToMoveDisplay (ref), p2 (copy) ]]
		if v18 then
			v18:Cancel()
			v18 = nil
		end
...
local function ShowPathFailedFeedback(p1) --[[ ShowPathFailedFeedback | Line: 703 | Upvalues: v18 (ref), v8 (ref), ClickToMoveDisplay (copy) ]]
...
function OnTap(p1, p2, p3) --[[ OnTap | Line: 713 | Upvalues: Workspace (copy), LocalPlayer (copy), t3 (copy), t2 (copy), v14 (ref), StarterGui (copy), Players (copy), v18 (ref), v19 (ref), v20 (ref), Pather (copy), HandleMoveTo (copy), v8 (ref), ClickToMoveDisplay (copy), GetEquippedTool (copy) ]]
...
local function DisconnectEvent(p1) --[[ DisconnectEvent | Line: 766 ]]
	if not p1 then
		return
	end
	p1:Disconnect()
...
v21.__index = v21
function v21.new(p1) --[[ new | Line: 777 | Upvalues: Keyboard (copy), v21 (copy) ]]
...
function v21.DisconnectEvents(p1) --[[ DisconnectEvents | Line: 809 ]]
...
function v21.OnTouchBegan(p1, p2, p3) --[[ OnTouchBegan | Line: 822 ]]
	if p1.fingerTouches[p2] == nil and not p3 then
		p1.numUnsunkTouches = p1.numUnsunkTouches + 1
	end
	p1.fingerTouches[p2] = p3
end
function v21.OnTouchChanged(p1, p2, p3) --[[ OnTouchChanged | Line: 829 ]]
...
function v21.OnTouchEnded(p1, p2, p3) --[[ OnTouchEnded | Line: 838 ]]
	if p1.fingerTouches[p2] ~= nil and p1.fingerTouches[p2] == false then
		p1.numUnsunkTouches = p1.numUnsunkTouches - 1
	end
	p1.fingerTouches[p2] = nil
end
function v21.OnCharacterAdded(p1, p2) --[[ OnCharacterAdded | Line: 846 | Upvalues: UserInputService (copy), t (copy), v18 (ref), v19 (ref), v20 (ref), ClickToMoveDisplay (copy), GuiService (copy) ]]
	p1:DisconnectEvents()
	p1.inputBeganConn = UserInputService.InputBegan:Connect(function(p12, p2) --[[ Line: 849 | Upvalues: p1 (copy), t (ref), v18 (ref), v19 (ref), v20 (ref), ClickToMoveDisplay (ref) ]]
	...
	p1.inputChangedConn = UserInputService.InputChanged:Connect(function(p12, p2) --[[ Line: 870 | Upvalues: p1 (copy) ]]
		if p12.UserInputType ~= Enum.UserInputType.Touch then
			return
		end
		p1:OnTouchChanged(p12, p2)
	end)
	p1.inputEndedConn = UserInputService.InputEnded:Connect(function(p12, p2) --[[ Line: 876 | Upvalues: p1 (copy), v18 (ref) ]]
		if p12.UserInputType == Enum.UserInputType.Touch then
	...
	p1.tapConn = UserInputService.TouchTap:Connect(function(p1, p2) --[[ Line: 893 ]]
		if p2 then
			return
		end
		OnTap(p1, nil, true)
	end)
	p1.menuOpenedConnection = GuiService.MenuOpened:Connect(function() --[[ Line: 899 | Upvalues: v18 (ref), v19 (ref), v20 (ref) ]]
		if v18 then
			v18:Cancel()
			v18 = nil
		end
	...
	local function OnCharacterChildAdded(p12) --[[ OnCharacterChildAdded | Line: 903 | Upvalues: UserInputService (ref), p1 (copy) ]]
		...
		p1.humanoidDiedConn = p12.Died:Connect(function() --[[ Line: 911 ]] end)
	end
	p1.characterChildAddedConn = p2.ChildAdded:Connect(function(p1) --[[ Line: 919 | Upvalues: OnCharacterChildAdded (copy) ]]
		OnCharacterChildAdded(p1)
	end)
	p1.characterChildRemovedConn = p2.ChildRemoved:Connect(function(p1) --[[ Line: 922 | Upvalues: UserInputService (ref) ]]
...
function v21.Start(p1) --[[ Start | Line: 934 ]]
	p1:Enable(true)
end
function v21.Stop(p1) --[[ Stop | Line: 938 ]]
	p1:Enable(false)
end
function v21.CleanupPath(p1) --[[ CleanupPath | Line: 942 | Upvalues: v18 (ref), v19 (ref), v20 (ref) ]]
	if v18 then
		v18:Cancel()
		v18 = nil
	end
...
function v21.Enable(p1, p2, p3, p4) --[[ Enable | Line: 946 | Upvalues: LocalPlayer (copy), v18 (ref), v19 (ref), v20 (ref), UserInputService (copy) ]]
	if p2 then
		if not p1.running then
			if LocalPlayer.Character then
				p1:OnCharacterAdded(LocalPlayer.Character)
			end
			p1.onCharacterAddedConn = LocalPlayer.CharacterAdded:Connect(function(p12) --[[ Line: 952 | Upvalues: p1 (copy) ]]
...
function v21.OnRenderStepped(p1, p2) --[[ OnRenderStepped | Line: 1007 | Upvalues: v18 (ref) ]]
	p1.isJumping = false
	if v18 then
...
function v21.UpdateMovement(p1, p2) --[[ UpdateMovement | Line: 1042 ]]
...
function v21.UpdateJump(p1) --[[ UpdateJump | Line: 1051 ]] end
function v21.SetShowPath(p1, p2) --[[ SetShowPath | Line: 1056 | Upvalues: v7 (ref) ]]
	v7 = p2
end
function v21.GetShowPath(p1) --[[ GetShowPath | Line: 1060 | Upvalues: v7 (ref) ]]
	return v7
end
function v21.SetWaypointTexture(p1, p2) --[[ SetWaypointTexture | Line: 1064 | Upvalues: ClickToMoveDisplay (copy) ]]
	ClickToMoveDisplay.SetWaypointTexture(p2)
end
function v21.GetWaypointTexture(p1) --[[ GetWaypointTexture | Line: 1068 | Upvalues: ClickToMoveDisplay (copy) ]]
	return ClickToMoveDisplay.GetWaypointTexture()
end
function v21.SetWaypointRadius(p1, p2) --[[ SetWaypointRadius | Line: 1072 | Upvalues: ClickToMoveDisplay (copy) ]]
	ClickToMoveDisplay.SetWaypointRadius(p2)
end
function v21.GetWaypointRadius(p1) --[[ GetWaypointRadius | Line: 1076 | Upvalues: ClickToMoveDisplay (copy) ]]
	return ClickToMoveDisplay.GetWaypointRadius()
end
function v21.SetEndWaypointTexture(p1, p2) --[[ SetEndWaypointTexture | Line: 1080 | Upvalues: ClickToMoveDisplay (copy) ]]
	ClickToMoveDisplay.SetEndWaypointTexture(p2)
end
function v21.GetEndWaypointTexture(p1) --[[ GetEndWaypointTexture | Line: 1084 | Upvalues: ClickToMoveDisplay (copy) ]]
	return ClickToMoveDisplay.GetEndWaypointTexture()
end
function v21.SetWaypointsAlwaysOnTop(p1, p2) --[[ SetWaypointsAlwaysOnTop | Line: 1088 | Upvalues: ClickToMoveDisplay (copy) ]]
	ClickToMoveDisplay.SetWaypointsAlwaysOnTop(p2)
end
function v21.GetWaypointsAlwaysOnTop(p1) --[[ GetWaypointsAlwaysOnTop | Line: 1092 | Upvalues: ClickToMoveDisplay (copy) ]]
	return ClickToMoveDisplay.GetWaypointsAlwaysOnTop()
end
function v21.SetFailureAnimationEnabled(p1, p2) --[[ SetFailureAnimationEnabled | Line: 1096 | Upvalues: v8 (ref) ]]
	v8 = p2
end
function v21.GetFailureAnimationEnabled(p1) --[[ GetFailureAnimationEnabled | Line: 1100 | Upvalues: v8 (ref) ]]
	return v8
end
function v21.SetIgnoredPartsTag(p1, p2) --[[ SetIgnoredPartsTag | Line: 1104 | Upvalues: UpdateIgnoreTag (copy) ]]
	UpdateIgnoreTag(p2)
end
function v21.GetIgnoredPartsTag(p1) --[[ GetIgnoredPartsTag | Line: 1108 | Upvalues: v15 (ref) ]]
	return v15
end
function v21.SetUseDirectPath(p1, p2) --[[ SetUseDirectPath | Line: 1112 | Upvalues: v9 (ref) ]]
	v9 = p2
end
function v21.GetUseDirectPath(p1) --[[ GetUseDirectPath | Line: 1116 | Upvalues: v9 (ref) ]]
	return v9
end
function v21.SetAgentSizeIncreaseFactor(p1, p2) --[[ SetAgentSizeIncreaseFactor | Line: 1120 | Upvalues: v10 (ref) ]]
	v10 = p2 / 100 + 1
end
function v21.GetAgentSizeIncreaseFactor(p1) --[[ GetAgentSizeIncreaseFactor | Line: 1124 | Upvalues: v10 (ref) ]]
	return (v10 - 1) * 100
end
function v21.SetUnreachableWaypointTimeout(p1, p2) --[[ SetUnreachableWaypointTimeout | Line: 1128 | Upvalues: v11 (ref) ]]
	v11 = p2
end
function v21.GetUnreachableWaypointTimeout(p1) --[[ GetUnreachableWaypointTimeout | Line: 1132 | Upvalues: v11 (ref) ]]
	return v11
end
function v21.SetUserJumpEnabled(p1, p2) --[[ SetUserJumpEnabled | Line: 1136 ]]
	p1.jumpEnabled = p2
...
function v21.GetUserJumpEnabled(p1) --[[ GetUserJumpEnabled | Line: 1143 ]]
	return p1.jumpEnabled
end
function v21.MoveTo(p1, p2, p3, p4) --[[ MoveTo | Line: 1147 | Upvalues: LocalPlayer (copy), Pather (copy), HandleMoveTo (copy) ]]
	local Character = LocalPlayer.Character
