...
v1.__index = v1
function v1.new() --[[ new | Line: 20 | Upvalues: BaseCamera (copy), v1 (copy) ]]
...
function v1.GetModuleName(p1) --[[ GetModuleName | Line: 30 ]]
	return "LegacyCamera"
end
function v1.SetCameraToSubjectDistance(p1, p2) --[[ SetCameraToSubjectDistance | Line: 35 | Upvalues: BaseCamera (copy) ]]
	return BaseCamera.SetCameraToSubjectDistance(p1, p2)
end
function v1.Update(p1, p2) --[[ Update | Line: 39 | Upvalues: Players (copy), CameraInput (copy) ]]
