...
local v20 = v5.GetRemoteEvent("AppleMinigame")
...
local GingerbreadDesign = Assets:WaitForChild("GingerbreadDesign")
local v23 = v3.new()
local v24 = v3.new()
local v25 = nil
local v26 = v10.new(Enum.RenderPriority.Camera.Value + 1, "AppleDesignShaker", function(p1) --[[ Line: 44 | Upvalues: CurrentCamera (copy) ]]
	CurrentCamera.CFrame = CurrentCamera.CFrame * p1
end)
v26:Start()
local t2 = { "Cookie", "Clothes", "Eyes", "Frosting", "Hold" }
local ContainerFrame = Player:WaitForChild("PlayerGui"):WaitForChild("AppleDesignMinigameGui"):WaitForChild("ContainerFrame")
local v27 = nil
function t._init(p1) --[[ _init | Line: 62 | Upvalues: v3 (copy), v4 (copy), v18 (copy) ]]
	p1.Maid = v3.new()
	p1.Maid:GiveTask(v4.new(p1.Object, {
		ShowHintLabel = true,
		Hint = "Design A Gingerbread Man!",
		Run = function() --[[ Run | Line: 67 | Upvalues: v18 (ref), p1 (copy) ]]
			v18._inAppleDesign = true
			p1:_startMinigame()
		end,
		Visibility = function() --[[ Visibility | Line: 72 | Upvalues: v18 (ref) ]]
			return not v18.Humanoid.SeatPart
		end
	}))
end
function t.new(p1) --[[ new | Line: 78 | Upvalues: t (copy) ]]
	local v2 = setmetatable({}, t)
	v2.Object = p1
	v2:_init()
	return v2
end
function t._startMinigame(p1) --[[ _startMinigame | Line: 88 | Upvalues: v25 (ref), v27 (ref), v22 (copy), v18 (copy), v6 (copy), v12 (copy), v23 (copy), v24 (copy), v16 (copy), v8 (copy), ContainerFrame (copy), CurrentCamera (copy), v17 (copy), RunService (copy), v19 (copy), v7 (copy), v13 (copy), Player (copy), TweenService (copy) ]]
	if v25 then
		v25:Destroy()
	end
	v27 = p1
	local v1 = v22.CoolDown * 60
	local v2 = v18._lastAppleMinigame or 0
	if workspace:GetServerTimeNow() - v2 <= v22.CoolDown * 190 then
		...
		v6.Notify({
			Message = "Drag the ingredients onto the mat to build your Gingerbreadman!!",
			Preset = "Yellow"
		})
	end
	v23:DoCleaning()
	...
	v23:GiveTask(RunService.Heartbeat:Connect(function() --[[ Line: 126 | Upvalues: p1 (copy), v19 (ref), CurrentCamera (ref), v7 (ref), v8 (ref), v13 (ref), Player (ref) ]]
	...
	v23:GiveTask(function() --[[ Line: 154 | Upvalues: v7 (ref), CurrentCamera (ref), TweenService (ref), v4 (copy), v18 (ref) ]]
		v7.stop(CurrentCamera)
		local v1 = TweenService:Create(CurrentCamera, TweenInfo.new(0.5), {
			CFrame = v4
		})
		v1:Play()
		v1.Completed:Once(function() --[[ Line: 158 | Upvalues: CurrentCamera (ref) ]]
...
function t._updateModel(p1, p2) --[[ _updateModel | Line: 170 | Upvalues: GingerbreadDesign (copy), v23 (copy) ]]
	if p2 then
		p1._model:FindFirstChild(p2, true).Transparency = 0
		return
	end
	p1._model = GingerbreadDesign:Clone()
...
function t._updateStage(p1, p2) --[[ _updateStage | Line: 185 | Upvalues: v24 (copy), SFX (copy), v7 (copy), Assets (copy), v11 (copy), TweenService (copy), v26 (copy), v10 (copy), v9 (copy), GingerbreadDesign (copy), t2 (copy) ]]
	p1._stage = math.clamp(p2, 1, 5)
	v24:DoCleaning()
	...
	local function rigAsset(p12, p2) --[[ rigAsset | Line: 197 | Upvalues: p1 (copy), v7 (ref), SFX (ref), Assets (ref), v11 (ref), v24 (ref), TweenService (ref), v26 (ref), v10 (ref), v9 (ref), Active (copy) ]]
		local v1 = p2:Clone()
		...
		if v2 then
			...
			v5(p12 * v6, function() --[[ Line: 206 | Upvalues: v1 (ref), v7 (ref), v3 (copy), SFX (ref) ]]
				local v12 = v1
			...
			local function showBillboard(p1) --[[ showBillboard | Line: 223 | Upvalues: v72 (copy), v7 (ref) ]]
				if not p1 then
					v7.stop(v72)
			...
			v24:GiveTask(DragDetector.MouseHoverEnter:Connect(function() --[[ Line: 240 | Upvalues: v7 (ref), v1 (ref), v3 (copy), showBillboard (copy), SFX (ref) ]]
				v7.target(v1, 0.8, 3, {
					Size = v3 * 1.2
				})
				showBillboard(true)
			...
			v24:GiveTask(DragDetector.MouseHoverLeave:Connect(function() --[[ Line: 246 | Upvalues: v7 (ref), v1 (ref), v3 (copy), v72 (copy) ]]
				v7.target(v1, 0.8, 3, {
					Size = v3
				})
				v7.stop(v72)
			...
			local v8 = false
			v24:GiveTask(DragDetector.DragEnd:Connect(function() --[[ Line: 252 | Upvalues: v8 (ref), p1 (ref), v1 (ref), TweenService (ref), v26 (ref), v10 (ref), v7 (ref), v3 (copy), v4 (copy) ]]
				if v8 then
			...
			v24:GiveTask(DragDetector.DragStart:Connect(function() --[[ Line: 283 | Upvalues: v26 (ref), v10 (ref), showBillboard (copy) ]]
				v26:Shake(v10.Presets.SmallBump)
				showBillboard(true)
			end))
			v24:GiveTask(DragDetector.DragContinue:Connect(function() --[[ Line: 288 | Upvalues: DragDetector (copy), v9 (ref), p1 (ref), Active (ref), v1 (ref), v8 (ref), SFX (ref), v72 (copy), v7 (ref), Size (copy) ]]
	...
	for v1, v2 in GingerbreadDesign:FindFirstChild(t2[p1._stage]):GetChildren() do
		rigAsset(v1, v2)
	end
end
function t._endGame(p1, p2) --[[ _endGame | Line: 322 | Upvalues: v18 (copy), v27 (ref), SFX (copy), v25 (ref), CurrentCamera (copy), v6 (copy), v13 (copy), v16 (copy), v8 (copy), ContainerFrame (copy), v24 (copy), v23 (copy), v22 (copy), v20 (copy), v17 (copy) ]]
	...
	if not (workspace:GetServerTimeNow() - (v18._lastAppleMinigame or 0) >= v22.CoolDown * 60) then
		v17.UpdateVisibility(false)
		return
	end
	v20:FireServer()
	v18._lastAppleMinigame = workspace:GetServerTimeNow()
	v17.UpdateVisibility(false)
end
function t.Destroy(p1) --[[ Destroy | Line: 365 ]]
	if p1.Maid then
		p1.Maid:DoCleaning()
	end
	setmetatable(p1, nil)
...
function t.Init() --[[ Init | Line: 373 | Upvalues: v2 (copy), t (copy), v8 (copy), ContainerFrame (copy), v14 (copy), v27 (ref), v15 (copy) ]]
	v2.new("AppleMinigame", t):Init()
	...
	v14.new(ContainerFrame:FindFirstChild("CloseButton", true), {
		Click = function() --[[ Click | Line: 387 | Upvalues: v27 (ref) ]]
			if v27 then
				v27:_endGame()
			end
		end
	})
	v8.AddStateCallback(ContainerFrame, "OnClose", function() --[[ Line: 393 | Upvalues: v27 (ref) ]]
		if v27 then
			v27:_endGame()
		end
	end)
	v15:AddControls("GamepadCloseAppleMinigame", { Enum.KeyCode.ButtonB }, {
		InputBegan = function() --[[ InputBegan | Line: 401 | Upvalues: v27 (ref) ]]
			if v27 then
				v27:_endGame()
			end
		end
	}, function() --[[ Line: 405 | Upvalues: v27 (ref) ]]
		return v27
	end, nil, true)
end
t.Init()
