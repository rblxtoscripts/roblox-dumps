...
function t.GetFormattedMonth(p1) --[[ GetFormattedMonth | Line: 81 | Upvalues: t (copy) ]]
...
function t.GetDayOfTheMonth(p1) --[[ GetDayOfTheMonth | Line: 90 | Upvalues: t (copy), GetDaysMonth (copy) ]]
	local v1 = t.GetYear(p1)
	local sum = t.GetDay(p1)
	local v2 = GetDaysMonth(v1)
	for i = 1, #v2 do
...
function t.GetFormattedDayOfTheMonth(p1) --[[ GetFormattedDayOfTheMonth | Line: 107 | Upvalues: t (copy) ]]
...
function t.GetMonthName(p1) --[[ GetMonthName | Line: 117 | Upvalues: t2 (copy), t (copy) ]]
	return t2[t.GetMonth(p1)]
end
function t.GetMonthNameShort(p1) --[[ GetMonthNameShort | Line: 121 | Upvalues: t3 (copy), t (copy) ]]
	return t3[t.GetMonth(p1)]
end
function t.GetJulianDate(p1) --[[ GetJulianDate | Line: 125 | Upvalues: t (copy) ]]
	local v1 = t.GetMonth(p1)
	local v2 = (14 - v1) / 12
	local v3 = t.GetYear(p1) + 4800 - v2
	return t.GetDay(p1) + (153 * (v1 + 12 * v2 - 3) + 2) / 5 + 365 * v3 + v3 / 4 - v3 / 100 + v3 / 400 - 32045
end
function t.GetDayOfTheWeek(p1) --[[ GetDayOfTheWeek | Line: 147 | Upvalues: t (copy) ]]
	return math.floor((t.GetJulianDate(p1))) % 7
end
function t.GetDayOfTheWeekName(p1) --[[ GetDayOfTheWeekName | Line: 154 | Upvalues: t (copy), t5 (copy) ]]
	return t5[t.GetDayOfTheWeek(p1) + 1]
end
function t.GetDayOfTheWeekNameShort(p1) --[[ GetDayOfTheWeekNameShort | Line: 159 | Upvalues: t (copy), t6 (copy) ]]
	return t6[t.GetDayOfTheWeek(p1) + 1]
end
function t.GetOrdinalOfNumber(p1) --[[ GetOrdinalOfNumber | Line: 166 ]]
	local v1 = p1 % 10
	local v2 = p1 % 100
...
function t.GetDayOfTheMonthOrdinal(p1) --[[ GetDayOfTheMonthOrdinal | Line: 185 | Upvalues: t (copy) ]]
	return t.GetOrdinalOfNumber((t.GetDayOfTheMonth(p1)))
end
function t.GetFormattedSecond(p1) --[[ GetFormattedSecond | Line: 191 | Upvalues: t (copy) ]]
...
function t.GetFormattedMinute(p1) --[[ GetFormattedMinute | Line: 199 | Upvalues: t (copy) ]]
...
function t.GetRegularHour(p1) --[[ GetRegularHour | Line: 209 | Upvalues: t (copy) ]]
...
function t.GetHourFormatted(p1) --[[ GetHourFormatted | Line: 219 | Upvalues: t (copy) ]]
...
function t.GetRegularHourFormatted(p1) --[[ GetRegularHourFormatted | Line: 229 | Upvalues: t (copy) ]]
...
function t.GetamOrpm(p1) --[[ GetamOrpm | Line: 239 | Upvalues: t (copy) ]]
...
function t.GetAMorPM(p1) --[[ GetAMorPM | Line: 249 | Upvalues: t (copy) ]]
	if t.GetHour(p1) > 12 then
		return "PM"
	else
		return "AM"
...
function t.GetMilitaryHour(p1) --[[ GetMilitaryHour | Line: 259 | Upvalues: t (copy) ]]
	local _ = t.GetHour(p1) < 10
end
function t.LeapYear(p1) --[[ LeapYear | Line: 267 | Upvalues: t (copy) ]]
	local v1 = t.GetYear(p1)
...
function t.GetDaysInMonth(p1) --[[ GetDaysInMonth | Line: 277 | Upvalues: t (copy), GetDaysMonth (copy) ]]
	local v1 = t.GetMonth(p1)
...
local v2 = v1 .. "]"
function t.GetFormattedTime(p1, p2) --[[ GetFormattedTime | Line: 338 | Upvalues: v2 (ref), tbl (copy) ]]
	...
	for k, v in pairs(tbl2) do
		local v6 = tbl[v](v3)
		v22 = v22:gsub(v:rep(3), (tostring(v6 or "")))
	end
	return v22
end
return t