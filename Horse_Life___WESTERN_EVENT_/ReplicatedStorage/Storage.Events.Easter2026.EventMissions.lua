...
return {
	...
	HeartSkills = {
		...
		Missions = {
			...
			Mission2 = {
				Type = "CompleteEventMinigame",
				Description = "Complete the Valentines Maze Minigame %s times",
				Amount = 2,
	...
	Heartbound = {
		...
		Missions = {
			...
			Mission4 = {
				...
				Amount = 5,
				Description = "Interact with %s unique Valentines Lore Structures in the World"
			}
		},
		Rewards = {
			{
	...
	LoveyDovey = {
		...
		Missions = {
			...
			Mission3 = {
				Type = "CompleteEventMinigame",
				Amount = 1,
				Description = "Complete the Valentines Maze Minigame %s time",
