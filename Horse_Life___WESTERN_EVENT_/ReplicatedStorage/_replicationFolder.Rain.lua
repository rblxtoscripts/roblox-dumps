...
table.sort(t2, function(p1, p2) --[[ Line: 258 ]]
	return p1.magnitude < p2.magnitude
end)
local __RainSoundGroup = Instance.new("SoundGroup")
__RainSoundGroup.Name = "__RainSoundGroup"
__RainSoundGroup.Volume = 0.2
__RainSoundGroup.Archivable = false
local RainSound = Instance.new("Sound")
RainSound.Name = "RainSound"
RainSound.Volume = v15
RainSound.SoundId = "rbxassetid://1516791621"
RainSound.Looped = true
RainSound.SoundGroup = game:GetService("SoundService"):WaitForChild("Effects")
RainSound.Parent = __RainSoundGroup
...
local t7 = {
	[t.None] = function(p1, p2) --[[ Line: 373 | Upvalues: __RainEmitter (ref), Players (copy), t6 (copy) ]]
		local v1 = workspace
		local v2
		if p2 then
			v2 = {}
	...
	[t.Blacklist] = function(p1) --[[ Line: 376 | Upvalues: v19 (ref) ]]
		return workspace:FindPartOnRayWithIgnoreList(p1, v19)
	end,
	[t.Whitelist] = function(p1) --[[ Line: 379 | Upvalues: v19 (ref) ]]
		return workspace:FindPartOnRayWithWhitelist(p1, v19)
	end,
	[t.Function] = function(p1) --[[ Line: 382 | Upvalues: t6 (copy), v20 (ref) ]]
...
local v27 = t7[None]
local function connectLoop() --[[ connectLoop | Line: 397 | Upvalues: t3 (ref), RunService (copy), v27 (ref), v16 (ref), v17 (ref), v15 (ref), v18 (ref), TweenService (copy), RainSound (copy), __RainEmitter (ref), v12 (copy), v13 (copy), v21 (ref), v14 (copy), v22 (ref), t5 (ref), v23 (ref), t4 (ref), v24 (ref) ]]
	local v1 = Random.new()
	local v2 = true
	local v3 = 6
	local v4 = tick()
	local function f6() --[[ Line: 405 | Upvalues: v4 (ref), v27 (ref), v16 (ref), v17 (ref), v15 (ref), v18 (ref), TweenService (ref), RainSound (ref), v3 (ref), __RainEmitter (ref), v12 (ref), v2 (ref) ]]
		if tick() - v4 < 0.02 then
			return
		end
		v4 = tick()
		if v17 and not (workspace.CurrentCamera.CFrame.p.y <= v17) or v27(Ray.new(workspace.CurrentCamera.CFrame.p, -v16 * 1000), true) then
			__RainEmitter.RainStraight.Enabled = false
			__RainEmitter.RainTopDown.Enabled = false
			v2 = true
			return
		end
		if v15 < 1 and not v18 then
			TweenService:Create(RainSound, TweenInfo.new(0.5), {
				Volume = 0.1
			}):Play()
		end
		v3 = 6
		local v32 = math.abs((workspace.CurrentCamera.CFrame.lookVector:Dot(v16)))
		local p = workspace.CurrentCamera.CFrame.p
		local v42 = workspace.CurrentCamera.CFrame.lookVector:Cross(-v16)
		local v5 = v42.magnitude > 0.001 and v42.unit or -v16
		local unit = v16:Cross(v5).unit
		__RainEmitter.Size = v12(60, 60, (1 - v32) * 80 + 60)
		__RainEmitter.CFrame = CFrame.new(p.x, p.y, p.z, v5.x, -v16.x, unit.x, v5.y, -v16.y, unit.y, v5.z, -v16.z, unit.z) + (1 - v32) * workspace.CurrentCamera.CFrame.lookVector * __RainEmitter.Size.Z / 3 - v32 * v16 * 30
		__RainEmitter.RainStraight.Enabled = true
		__RainEmitter.RainTopDown.Enabled = true
		v2 = false
	end
	table.insert(t3, RunService.Heartbeat:connect(f6))
	local function f8() --[[ Line: 457 | Upvalues: v3 (ref), v16 (ref), v13 (ref), v21 (ref), v14 (ref), v22 (ref), v2 (ref), t5 (ref), __RainEmitter (ref), v23 (ref), t4 (ref), v1 (copy), v27 (ref), v12 (ref), v17 (ref), v24 (ref) ]]
		v3 = v3 + 1
		if v3 >= 6 then
			local v25 = math.abs((workspace.CurrentCamera.CFrame.lookVector:Dot(v16)))
			local v32 = NumberSequence.new({
				v13,
				NumberSequenceKeypoint.new(0.25, (1 - v25) * v21 + v25, 0),
				NumberSequenceKeypoint.new(0.75, (1 - v25) * v21 + v25, 0),
				v14
			})
			local v4 = NumberSequence.new({
				v13,
				NumberSequenceKeypoint.new(0.25, v25 * v22 + (1 - v25), 0),
				NumberSequenceKeypoint.new(0.75, v25 * v22 + (1 - v25), 0),
				v14
			})
			local v5 = workspace.Camera.CFrame:inverse() * (workspace.Camera.CFrame.p - v16)
		...
		local p = workspace.CurrentCamera.CFrame.p
		local v10 = workspace.CurrentCamera.CFrame.lookVector:Cross(-v16)
		local v11 = v10.magnitude > 0.001 and v10.unit or -v16
		local unit = v16:Cross(v11).unit
		local v122 = CFrame.new(p.x, p.y, p.z, v11.x, -v16.x, unit.x, v11.y, -v16.y, unit.y, v11.z, -v16.z, unit.z)
		local v132 = v16 * 550
		for i = 1, v23 do
			local v142 = t4[i]
			local v15 = t5[i]
			local v162 = v1:NextNumber(-100, 100)
			local v172 = v1:NextNumber(-100, 100)
			local v18, v19, v20 = v27(Ray.new(v122 * v12(v162, 500, v172), v132))
			if v18 then
				v142.Position = v19 + v20 * 0.5
				v142.RainSplash:Emit(1)
				if v2 then
					local sum = v19 - v16 * 50
					if v17 and (v17 < sum.Y and v16.Y < 0) then
						sum = sum + v16 * (v17 - sum.Y) / v16.Y
					end
					v15.CFrame = v122 - v122.p + sum
					v15.RainStraight:Emit(v24)
					v15.RainTopDown:Emit(v24)
				end
				continue
			end
			if v2 then
				local sum = v122 * v12(v162, v1:NextNumber(20, 100), v172)
				if v17 and (v17 < sum.Y and v16.Y < 0) then
					sum = sum + v16 * (v17 - sum.Y) / v16.Y
				end
				v15.CFrame = v122 - v122.p + sum
	...
	table.insert(t3, RunService.Heartbeat:connect(f8))
end
local function disconnectLoop() --[[ disconnectLoop | Line: 557 | Upvalues: t3 (ref) ]]
	if not (#t3 > 0) then
		return
	end
...
local function disableSound(p1) --[[ disableSound | Line: 567 | Upvalues: v15 (ref), TweenService (copy), RainSound (copy) ]]
	v15 = 0
	local v1 = TweenService:Create(RainSound, p1, {
		Volume = 0
	})
	v1.Completed:connect(function(p1) --[[ Line: 573 | Upvalues: RainSound (ref), v1 (copy) ]]
...
local function disable() --[[ disable | Line: 583 | Upvalues: disconnectLoop (copy), __RainEmitter (ref), v18 (ref), disableSound (copy) ]]
	disconnectLoop()
	__RainEmitter.RainStraight.Enabled = false
	__RainEmitter.RainTopDown.Enabled = false
	__RainEmitter.Size = Vector3.new(0.05, 0.05, 0.05)
...
local function makeProperty(p1, p2, p3) --[[ makeProperty | Line: 598 ]]
...
local function f28(p1) --[[ Line: 611 | Upvalues: __RainEmitter (ref), t4 (ref), t5 (ref) ]]
...
local function updateTransparency(p1) --[[ updateTransparency | Line: 627 | Upvalues: v11 (copy), v21 (ref), v22 (ref), v13 (copy), v14 (copy), t4 (ref) ]]
...
v32.Value = 1
v32.Changed:connect(function(p1) --[[ Line: 649 | Upvalues: __RainEmitter (ref) ]]
...
v35.Value = 1
v35.Changed:connect(function(p1) --[[ Line: 654 | Upvalues: __RainEmitter (ref), v24 (ref), v23 (ref) ]]
...
local v37 = v35
local function f38(p1) --[[ Line: 662 | Upvalues: __RainEmitter (ref), t5 (ref), t4 (ref) ]]
...
f38(v39.Value)
local v40 = v39
local function f41(p1) --[[ Line: 675 | Upvalues: __RainEmitter (ref), t5 (ref), t4 (ref) ]]
...
Vector3Value.Changed:connect(function(p1) --[[ Line: 689 | Upvalues: v16 (ref) ]]
...
if not (v44.magnitude > 0.001) then
	...
	v46 = {
		CollisionMode = t,
		Enable = function(p1_2, p2_2) --[[ Enable | Line: 700 | Upvalues: disconnectLoop (copy), __RainEmitter (ref), t4 (ref), t5 (ref), RunService (copy), __RainSoundGroup (copy), connectLoop (copy), TweenService (copy), v11 (copy), RainSound (copy), v18 (ref) ]]
			...
			__RainEmitter.RainStraight.Enabled = true
			__RainEmitter.RainTopDown.Enabled = true
			__RainEmitter.Parent = workspace.CurrentCamera
			for i = 1, 20 do
				t4[i].Parent = workspace.Terrain
				t5[i].Parent = workspace.Terrain
			end
			if RunService:IsRunning() then
				__RainSoundGroup.Parent = game:GetService("SoundService")
			end
			connectLoop()
			if p2_2 then
		...
		Disable = function(p1_2, p2_2) --[[ Disable | Line: 736 | Upvalues: TweenService (copy), v11 (copy), disconnectLoop (copy), __RainEmitter (ref), v18 (ref), disableSound (copy) ]]
			if p2_2 ~= nil and typeof(p2_2) ~= "TweenInfo" then
			...
			if p2_2 then
				...
				v1.Completed:connect(function(p1_2) --[[ Line: 744 | Upvalues: disconnectLoop (ref), __RainEmitter (ref), v18 (ref), disableSound (ref), v1 (copy) ]]
		...
		SetColor = function(p1_2, p2_2, p3_2) --[[ SetColor | Line: 765 | Upvalues: TweenService (copy), v29 (copy) ]]
	...
	_3 = function(p1_2, p2_2) --[[ makeRatioSetter | Line: 779 | Upvalues: TweenService (copy) ]]
		return function(p12_2_2_2_2_2_2_2_2_2_2_2, p22_2_2_2_2_2_2_2_2_2_2_2, p3_2_2_2_2_2_2_2_2_2_2_2) --[[ Line: 781 | Upvalues: p1_2 (copy), TweenService (ref), p2_2 (copy) ]]
	...
	function v46.SetCeiling(p1_2, p2_2) --[[ SetCeiling | Line: 837 | Upvalues: v17 (ref) ]]
		if p2_2 ~= nil and typeof(p2_2) ~= "number" then
			error("bad argument #1 to \'SetCeiling\' (number expected, got " .. typeof(p2_2) .. ")", 2)
		end
		v17 = p2_2
	end
	function v46.SetStraightTexture(p1_2, p2_2) --[[ SetStraightTexture | Line: 845 | Upvalues: __RainEmitter (ref), t5 (ref) ]]
		local v1 = p2_2 or "rbxassetid://1822883048"
		if typeof(v1) ~= "string" then
			error("bad argument #1 to \'SetStraightTexture\' (string expected, got " .. typeof(v1) .. ")", 2)
		end
		__RainEmitter.RainStraight.Texture = v1
		for k2, v in pairs(t5) do
			v.RainStraight.Texture = v1
		end
	end
	function v46.SetSize(p1_2, p2_2) --[[ SetSize | Line: 859 | Upvalues: __RainEmitter (ref), v2 (copy), t5 (ref), v4 (copy) ]]
		__RainEmitter.RainStraight.Size = p2_2 and NumberSequence.new(p2_2, p2_2) or v2
		for k2, v in pairs(t5) do
			v.RainStraight.Size = p2_2 and NumberSequence.new(p2_2, p2_2) or v2
		end
		__RainEmitter.RainTopDown.Size = p2_2 and NumberSequence.new(p2_2, p2_2) or v4
		for k2, v in pairs(t5) do
			v.RainTopDown.Size = p2_2 and NumberSequence.new(p2_2, p2_2) or v4
		end
	end
	function v46.SetTopDownTexture(p1_2, p2_2) --[[ SetTopDownTexture | Line: 873 | Upvalues: __RainEmitter (ref), t5 (ref) ]]
		local v1 = p2_2 or "rbxassetid://1822856633"
		if typeof(v1) ~= "string" then
			error("bad argument #1 to \'SetStraightTexture\' (string expected, got " .. typeof(v1) .. ")", 2)
		end
		__RainEmitter.RainTopDown.Texture = v1
		for k2, v in pairs(t5) do
			v.RainTopDown.Texture = v1
		end
	end
	function v46.SetSplashTexture(p1_2, p2_2) --[[ SetSplashTexture | Line: 887 | Upvalues: t4 (ref) ]]
		local v1 = p2_2 or "rbxassetid://1822856633"
		if typeof(v1) ~= "string" then
			error("bad argument #1 to \'SetStraightTexture\' (string expected, got " .. typeof(v1) .. ")", 2)
		end
		for k2, v in pairs(t4) do
			v.RainSplash.Texture = v1
		end
	end
	function v46.SetSoundId(p1_2, p2_2) --[[ SetSoundId | Line: 899 | Upvalues: RainSound (copy) ]]
		if typeof(p2_2) ~= "string" then
			error("bad argument #1 to \'SetSoundId\' (string expected, got " .. typeof(p2_2) .. ")", 2)
		end
		RainSound.SoundId = p2_2
	end
	function v46.SetCollisionMode(p1_2, p2_2, p3_2) --[[ SetCollisionMode | Line: 907 | Upvalues: t (copy), v19 (ref), v20 (ref), __RainEmitter (ref), None (ref), v27 (ref), t7 (copy) ]]
		if p2_2 == t.None then
			v19 = nil
			v20 = nil
		elseif p2_2 == t.Blacklist then
			if typeof(p3_2) == "Instance" then
				v19 = { p3_2, __RainEmitter }
