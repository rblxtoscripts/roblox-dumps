...
v2.ClassName = "XboxOneLight"
v2.__index = v2
function v2.new() --[[ new | Line: 12 | Upvalues: v1 (copy), v2 (copy) ]]
	local v3 = setmetatable(v1.new("rbxassetid://5104051626"), v2)
	...
	v3:AddSprite(Enum.KeyCode.Thumbstick1, Vector2.new(500, 100), Vector2.new(100, 100))
	v3:AddSprite(Enum.KeyCode.Thumbstick2, Vector2.new(600, 100), Vector2.new(100, 100))
	return v3
end
return v2