...
return function(p1, p2, p3, p4, p5) --[[ Line: 14 | Upvalues: v1 (copy), DataStoreService (copy) ]]
	if p4 <= 0 then
		return "Cannot add 0 or negative amounts of items!"
	end
	...
	return "Item " .. p3 .. " " .. p4 .. (p5 and " with theme " .. p5 or "") .. " was added to code " .. v2
end