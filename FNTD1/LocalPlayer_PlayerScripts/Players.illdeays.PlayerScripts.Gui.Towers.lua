...
local t5 = {}
local function hasEnchant(p1) --[[ hasEnchant | Line: 47 ]]
...
local function update(p1, p2) --[[ update | Line: 57 | Upvalues: ClientState (copy), UserInputService (copy), v1 (copy), InventoryFrame (copy), Towers (copy), v2 (ref), TowerStats (copy), t5 (copy), ReplicatedStorage (copy), Formatter (copy), t4 (ref), Units (copy), Misc (copy), Enchants (copy), LocalPlayer (copy) ]]
	...
	v2 = p1
	task.spawn(function() --[[ Line: 81 | Upvalues: v2 (ref), t5 (ref), v3 (copy), v22 (copy), TowerStats (ref), ReplicatedStorage (ref), Formatter (ref) ]]
		if not t5[v3 .. v22] then
	...
	local v6 = if t5[v3 .. v22] then t5[v3 .. v22] else 0
	if v6 > 0 then
	...
	if p2 then
		...
		local v11 = nil
		v11 = Units:GetPropertyChangedSignal("CanvasPosition"):Connect(function() --[[ Line: 137 | Upvalues: TowerStats (ref), v11 (ref) ]]
			TowerStats.Visible = false
			v11:Disconnect()
		end)
	end
	...
	elseif v22 == "Hermes Puppeteer" then
		v18 = nil
	elseif v22 == "Soulmate Puppet" or v22 == "Fossilized Puppet" then
		v17 = nil
	elseif v22 == "Paleontologist Springbonnie" then
		v18 = nil
	elseif v22 == "Alien Helpy" or v22 == "Funtime Chica" then
		v17 = nil
	elseif v22 == "Drained Coffee" then
		v16 = nil
	elseif v22 == "El Jellychip" then
		v18 = nil
	elseif v22 == "Glitchtrap" then
		v16 = nil
	end
	if v17 then
...
local function clearInv() --[[ clearInv | Line: 221 | Upvalues: t4 (ref), Units (copy) ]]
	t4 = {}
...
local t6 = {}
local function onClickInvFrame(p1, p2) --[[ onClickInvFrame | Line: 231 | Upvalues: InventoryFrame (copy), v4 (ref), t (ref), LocalPlayer (copy), ReplicatedStorage (copy), t2 (ref), Units (copy), update (copy), t6 (copy) ]]
	t6[p1] = p1.Activated:Connect(function() --[[ Line: 233 | Upvalues: InventoryFrame (ref), v4 (ref), p1 (copy), t (ref), p2 (copy), LocalPlayer (ref), ReplicatedStorage (ref), t2 (ref), Units (ref), update (ref) ]]
		...
		if LocalPlayer:FindFirstChild("Sell2Tower") then
			...
			t2 = {}
			LocalPlayer.Sell2Tower:Destroy()
			ReplicatedStorage.Remotes.Quests.Client.Sell.Bindable:Fire(p2)
			return
		end
...
function trueCheckEquipped(p1) --[[ trueCheckEquipped | Line: 336 | Upvalues: ClientState (copy) ]]
...
local function updateInv(p1, p2, p3) --[[ updateInv | Line: 353 | Upvalues: ClientState (copy), Units (copy), t4 (ref), Towers (copy), Rarities (copy), clearInv (copy), t6 (copy), onClickInvFrame (copy), ReplicatedStorage (copy), Template (copy), HttpService (copy), Misc (copy), PlayerGui (copy), Tween (copy) ]]
	local v1 = ClientState.GetData()
	if not v1 then
		return
	end
	...
	local v2 = nil
	if p1 then
		local v3 = if typeof(p1) == "table" or not Units:FindFirstChild(p1) then t4[p1] else Units[p1]
		Towers_2 = {}
		if v3 then
...
function updateFrame(p1) --[[ updateFrame | Line: 554 | Upvalues: ClientState (copy), Towers (copy), t4 (ref), Rarities (copy), Units (copy), v2 (ref), update (copy), TowerStats (copy) ]]
	if not p1 then
		return
	end
...
TowerStats.Frame.Equip.Activated:Connect(function() --[[ Line: 579 | Upvalues: v2 (ref), Towers_2 (copy) ]]
	if not v2 then
		return
	end
	Towers_2.Equip:FireServer(v2)
end)
TowerStats.Frame.Delete.Activated:Connect(function() --[[ Line: 585 | Upvalues: v2 (ref), ClientState (copy), t4 (ref), InventoryFrame (copy), v3 (ref) ]]
	if not v2 then
		return
	end
...
function updateMassDelete() --[[ updateMassDelete | Line: 604 | Upvalues: v4 (ref), InventoryFrame (copy), Units (copy) ]]
	if v4 then
...
InventoryFrame.MultiDelete.MouseButton1Click:Connect(function() --[[ Line: 623 | Upvalues: v4 (ref), t (ref), InventoryFrame (copy) ]]
	if v4 then
		if #t >= 1 then
...
TowerStats.Frame.Lock.Activated:Connect(function() --[[ Line: 638 | Upvalues: v2 (ref), ClientState (copy), t4 (ref), Towers_2 (copy) ]]
	if not v2 then
		return
	end
	local v1 = ClientState.GetData().Towers[v2]
...
TowerStats.Frame.Passive.Activated:Connect(function() --[[ Line: 651 | Upvalues: TowerStats (copy), v2 (ref), ClientState (copy), Towers (copy), ReplicatedStorage (copy) ]]
...
TowerStats.Frame.Stats.Activated:Connect(function() --[[ Line: 671 | Upvalues: TowerStats (copy), v2 (ref), ClientState (copy), StatRerolls (copy), LocalPlayer (copy) ]]
	if TowerStats.Frame.StatFrame.Visible then
		TowerStats.Frame.StatFrame.Visible = false
		return
	end
...
Towers_2.Lock.OnClientEvent:Connect(function(p1, p2) --[[ Line: 713 | Upvalues: TowerStats (copy), v2 (ref), ClientState (copy), t4 (ref) ]]
	if p2 then
		TowerStats.Frame.Lock.ImageColor3 = Color3.fromRGB(255, 203, 46)
		TowerStats.Frame.Lock.ImageLabel.Image = "rbxassetid://129873382316985"
	else
...
TowerStats.Frame.Info.Activated:Connect(function() --[[ Line: 730 | Upvalues: v2 (ref), Towers_2 (copy) ]]
	if v2 then
		Towers_2.ShowInfo:Fire(v2)
	end
end)
InventoryFrame.TradeAmount.Confirm.Activated:Connect(function() --[[ Line: 735 | Upvalues: InventoryFrame (copy), LocalPlayer (copy), ReplicatedStorage (copy) ]]
	InventoryFrame.Items.Visible = true
	InventoryFrame.Shop.Visible = true
	InventoryFrame.Units.Visible = true
	InventoryFrame.EnchantText.Visible = false
...
InventoryFrame.TradeAmount.Exit.Activated:Connect(function() --[[ Line: 752 | Upvalues: InventoryFrame (copy) ]]
	InventoryFrame.TradeAmount.Visible = false
end)
InventoryFrame.DeleteFrame.Confirm.Activated:Connect(function() --[[ Line: 756 | Upvalues: v3 (ref), InventoryFrame (copy), ClientState (copy), v2 (ref) ]]
...
InventoryFrame.DeleteFrame.Exit.Activated:Connect(function() --[[ Line: 774 | Upvalues: InventoryFrame (copy), v3 (ref), v2 (ref), TowerStats (copy) ]]
	InventoryFrame.DeleteFrame.Visible = false
	v3 = 0
...
InventoryFrame.ConfirmFrame.Yes.Activated:Connect(function() --[[ Line: 782 | Upvalues: v4 (ref), Towers_2 (copy), t (ref), v3 (ref), v2 (ref), InventoryFrame (copy), TowerStats (copy) ]]
	if v4 then
...
InventoryFrame.ConfirmFrame.No.Activated:Connect(function() --[[ Line: 799 | Upvalues: v4 (ref), t (ref), v3 (ref), InventoryFrame (copy) ]]
	if not v4 then
		v3 = 0
		InventoryFrame.ConfirmFrame.Visible = false
		return
...
InventoryFrame.ConfirmFrame.No.Activated:Connect(function() --[[ Line: 809 | Upvalues: InventoryFrame (copy) ]]
	InventoryFrame.ConfirmFrame.Visible = false
end)
InventoryFrame.UnequipAll.Activated:Connect(function() --[[ Line: 813 | Upvalues: Towers_2 (copy) ]]
	Towers_2.Equip:FireServer("UnequipAll")
end)
InventoryFrame.Search.TextBox:GetPropertyChangedSignal("Text"):Connect(function() --[[ Line: 817 | Upvalues: InventoryFrame (copy), Units (copy) ]]
...
Towers_2.Give.OnClientEvent:Connect(function(p1, p2) --[[ Line: 844 | Upvalues: updateInv (copy) ]]
	task.defer(updateInv, p1, p2)
end)
Towers_2.Delete.OnClientEvent:Connect(function(p1, p2) --[[ Line: 849 | Upvalues: updateInv (copy) ]]
	task.defer(updateInv, p1, p2)
end)
Towers_2.Enchanted.OnClientEvent:Connect(function(p1) --[[ Line: 854 | Upvalues: updateInv (copy) ]]
	task.defer(updateInv, p1)
end)
Towers_2.TowerUpdated.OnClientEvent:Connect(function(p1) --[[ Line: 859 | Upvalues: updateInv (copy) ]]
	task.defer(updateInv, p1)
end)
Towers_2.Equip.OnClientEvent:Connect(function(p1) --[[ Line: 864 | Upvalues: updateInv (copy) ]]
	task.spawn(updateFrame, p1)
	task.defer(updateInv, p1, true)
end)
Towers_2.Unequip.OnClientEvent:Connect(function(p1) --[[ Line: 869 | Upvalues: updateInv (copy) ]]
	task.spawn(updateFrame, p1)
	task.defer(updateInv, p1, true)
end)
Towers_2.FullUpdate.OnClientEvent:Connect(function() --[[ Line: 874 | Upvalues: updateInv (copy) ]]
	task.defer(updateInv)
end)
InventoryFrame:GetPropertyChangedSignal("Visible"):Connect(function() --[[ Line: 878 | Upvalues: InventoryFrame (copy), LocalPlayer (copy), t2 (ref), t3 (ref), PlayerGui (copy), Tween (copy) ]]
...
InventoryFrame.Exit.Activated:Connect(function() --[[ Line: 923 | Upvalues: LocalPlayer (copy), InventoryFrame (copy), t2 (ref) ]]
	if LocalPlayer:FindFirstChild("EvolveTower") then
		for k, v in pairs(InventoryFrame.Units:GetChildren()) do
			if v:IsA("ImageButton") and v.Name ~= "Example" then
				v.Visible = true
...
ReplicatedStorage.Remotes.PlayerData.UpdateData.OnClientEvent:Connect(function() --[[ Line: 960 | Upvalues: ClientState (copy), InventoryFrame (copy), TowersModule (copy) ]]
	local v1 = ClientState.GetData()
	InventoryFrame.Inventory.TextLabel.Text = TowersModule.GetStorage(v1) .. "/" .. TowersModule.GetMaxStorage(v1)
end)
ReplicatedStorage.Remotes.Misc.Evolve.Bindable.Event:Connect(function(p1) --[[ Line: 965 | Upvalues: Units (copy), HolderFrame (copy), TowerStats (copy), InventoryFrame (copy), ClientState (copy), Crafting (copy), t2 (ref), Tween (copy) ]]
	if p1 ~= 1 then
		return
	end
	Units.Visible = true
...
ReplicatedStorage.Remotes.Misc.Enchant.Bindable.Event:Connect(function(p1) --[[ Line: 1001 | Upvalues: Units (copy), HolderFrame (copy), TowerStats (copy), InventoryFrame (copy), Tween (copy) ]]
	if p1 == 1 then
		Units.Visible = true
		HolderFrame.Items.Visible = false
		HolderFrame.Shop.Visible = false
...
ReplicatedStorage.Remotes.Quests.Client.Sell.Bindable.Event:Connect(function(p1) --[[ Line: 1021 | Upvalues: Units (copy), HolderFrame (copy), TowerStats (copy), InventoryFrame (copy), ClientState (copy), Towers (copy), t2 (ref), t3 (ref), Tween (copy), LocalPlayer (copy), ReplicatedStorage (copy) ]]
	if p1 ~= 1 then
		return
	end
	Units.Visible = true
	...
	InventoryFrame.OpenPresent.Visible = false
	local v1 = ClientState.GetData()
	local t = { "Forgotten", "Apex", "Nightmare" }
	local t4 = {
		DoubleSpeed = 6,
		ShinyHunter = 18,
		QuickOpen = 5,
	...
	for k, v in pairs(HolderFrame.Units:GetChildren()) do
		if v:IsA("ImageButton") and v.Name ~= "Example" then
			local Rarity = Towers.Towers[if v1.Towers[v.TowerID.Value] then v1.Towers[v.TowerID.Value].Name else ""].Rarity
			if not table.find(t, Rarity) then
				if not t2[v] then
					t2[v] = v
				end
				v.Visible = false
	...
	for k, v in pairs(HolderFrame.Items:GetChildren()) do
		if t4[v.Name] then
			local v3 = v:Clone()
			v3.LayoutOrder = -999
			v3.Parent = HolderFrame.Units
			v3.BorderImage.Size = UDim2.new(1, 0, 0.77, 0)
			if v3:FindFirstChild("UIScale") then
				v3.UIScale:Destroy()
			end
			table.insert(t3, v3)
			Tween:AddButton(v3, nil, nil, nil, true)
			v3.MouseButton1Click:Connect(function() --[[ Line: 1067 | Upvalues: InventoryFrame (ref), t2 (ref), LocalPlayer (ref), ReplicatedStorage (ref), v3 (copy) ]]
				InventoryFrame.Items.Visible = true
				InventoryFrame.Shop.Visible = true
				InventoryFrame.Units.Visible = true
				InventoryFrame.EnchantText.Visible = false
				...
				t2 = {}
				LocalPlayer.Sell2Tower:Destroy()
				ReplicatedStorage.Remotes.Quests.Client.Sell.Bindable:Fire(v3.Name)
			end)
		end
	end
	InventoryFrame.Items.Visible = false
...
ReplicatedStorage.Remotes.Misc.StatReroll.Bindable.Event:Connect(function(p1) --[[ Line: 1098 | Upvalues: Units (copy), HolderFrame (copy), TowerStats (copy), InventoryFrame (copy), Tween (copy) ]]
	if p1 == 1 then
		Units.Visible = true
		HolderFrame.Items.Visible = false
		HolderFrame.Shop.Visible = false
...
ReplicatedStorage.Remotes.Misc.UseItem.Bindable.Event:Connect(function(p1, p2) --[[ Line: 1118 | Upvalues: Units (copy), HolderFrame (copy), TowerStats (copy), InventoryFrame (copy), Tween (copy), Towers (copy), Presents (copy), ClientState (copy), t2 (ref) ]]
	if p1 ~= 1 then
		return
	end
	Units.Visible = true
	...
	InventoryFrame.TradingText.Visible = false
	Tween:AddButton("Open", InventoryFrame)
	local function show(p1, p2) --[[ show | Line: 1137 | Upvalues: Towers (ref), Presents (ref) ]]
...
ReplicatedStorage.Remotes.Trading.Trade.Bindable.Event:Connect(function(p1, p2) --[[ Line: 1166 | Upvalues: Units (copy), HolderFrame (copy), TowerStats (copy), InventoryFrame (copy), Tween (copy) ]]
	if p1 == 1 then
		Units.Visible = true
		HolderFrame.Items.Visible = false
		HolderFrame.Shop.Visible = false
...
ReplicatedStorage.Remotes.Towers.MetaData.OnClientEvent:Connect(function(p1) --[[ Line: 1186 | Upvalues: Towers (copy) ]]
	if not p1 then
		return
	end
	if pcall(function() --[[ Line: 1188 | Upvalues: p1 (ref), Towers (ref) ]]
...
InventoryFrame.Units.Activated:Connect(function() --[[ Line: 1201 | Upvalues: Units (copy), HolderFrame (copy), TowerStats (copy), InventoryFrame (copy) ]]
	Units.Visible = true
	HolderFrame.Items.Visible = false
	HolderFrame.Shop.Visible = false
	HolderFrame.Teams.Visible = false
...
function updateTeamSlots(p1, p2) --[[ updateTeamSlots | Line: 1219 | Upvalues: ClientState (copy), Towers (copy), ReplicatedStorage (copy) ]]
	local v1 = ClientState.GetData()
	local tbl = {}
...
function updateTeams(p1) --[[ updateTeams | Line: 1280 | Upvalues: ClientState (copy), HolderFrame (copy) ]]
	local v1 = ClientState.GetData()
...
function initTeams() --[[ initTeams | Line: 1304 | Upvalues: HolderFrame (copy), Tween (copy) ]]
	...
	for k, v in pairs(HolderFrame.Teams:GetChildren()) do
		if v:IsA("ImageButton") then
			...
			v.Equip.MouseButton1Click:Connect(function() --[[ Line: 1314 | Upvalues: v (copy) ]]
				game.ReplicatedStorage.Remotes.Misc.Teams:FireServer("Equip", v.Name)
			end)
			v.Reset.MouseButton1Click:Connect(function() --[[ Line: 1317 | Upvalues: v (copy) ]]
				game.ReplicatedStorage.Remotes.Misc.Teams:FireServer("Clear", v.Name)
			end)
			v.Set.MouseButton1Click:Connect(function() --[[ Line: 1320 | Upvalues: v (copy) ]]
				game.ReplicatedStorage.Remotes.Misc.Teams:FireServer("Set", v.Name)
			end)
			v.Info.FocusLost:Connect(function() --[[ Line: 1323 | Upvalues: v (copy) ]]
				game.ReplicatedStorage.Remotes.Misc.Teams:FireServer("Name", v.Name, v.Info.Text)
			end)
		end
	end
end
InventoryFrame.Teams.MouseButton1Click:Connect(function() --[[ Line: 1330 | Upvalues: HolderFrame (copy), Units (copy) ]]
