...
local t2 = {}
function t2.FormatCompact(p1, p2) --[[ FormatCompact | Line: 6 | Upvalues: t2 (copy), t (copy) ]]
	if p1 == "HUGE" then
		return 1
	end
...
function t2.FormatToNumber(p1, p2) --[[ FormatToNumber | Line: 38 | Upvalues: t2 (copy), t (copy) ]]
