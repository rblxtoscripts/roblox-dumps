...
local v11 = 1
function t3.Vel(p1) --[[ Vel | Line: 167 | Upvalues: v11 (ref), t5 (copy), clamp (copy), thumbstickCurve (ref), t4 (copy), UserInputService (copy) ]]
...
function t3.Pan(p1) --[[ Pan | Line: 187 | Upvalues: thumbstickCurve (ref), t4 (copy), v10 (copy), t6 (copy), v9 (copy) ]]
...
function t3.StopCapture() --[[ StopCapture | Line: 259 | Upvalues: v11 (ref), t4 (copy), t5 (copy), t6 (copy), ContextActionService (copy) ]]
	v11 = 1
	local v1 = t4
...
local function GetFocusDistance(p1) --[[ GetFocusDistance | Line: 274 | Upvalues: CurrentCamera (ref), v5 (ref), tan (copy), Workspace (copy) ]]
...
local function StepFreecam(p1) --[[ StepFreecam | Line: 305 | Upvalues: v6 (copy), t3 (copy), v7 (copy), v8 (copy), v5 (ref), rad (copy), tan (copy), sqrt (copy), clamp (copy), v4 (ref), v2 (copy), v3 (ref), CurrentCamera (ref), GetFocusDistance (copy) ]]
...
function t7.Push() --[[ Push | Line: 346 | Upvalues: t9 (copy), StarterGui (copy), t10 (copy), LocalPlayer_2 (ref), t8 (copy), v17 (ref), CurrentCamera (ref), v14 (ref), v16 (ref), v15 (ref), v13 (ref), UserInputService (copy), v12 (ref) ]]
...
function t7.Pop() --[[ Pop | Line: 382 | Upvalues: t9 (copy), StarterGui (copy), t10 (copy), t8 (copy), CurrentCamera (ref), v17 (ref), v14 (ref), v16 (ref), v15 (ref), UserInputService (copy), v13 (ref), v12 (ref) ]]
...
local function StartFreecam() --[[ StartFreecam | Line: 415 | Upvalues: CurrentCamera (ref), v4 (ref), v3 (ref), v5 (ref), v6 (copy), v7 (copy), v8 (copy), t7 (copy), RunService (copy), StepFreecam (copy), t3 (copy) ]]
...
local function StopFreecam() --[[ StopFreecam | Line: 430 | Upvalues: t3 (copy), RunService (copy), t7 (copy) ]]
	t3.StopCapture()
	RunService:UnbindFromRenderStep("Freecam")
	t7.Pop()
end
local v18 = false
local function ToggleFreecam() --[[ ToggleFreecam | Line: 441 | Upvalues: v18 (ref), t3 (copy), RunService (copy), t7 (copy), StartFreecam (copy) ]]
	if v18 then
		t3.StopCapture()
		RunService:UnbindFromRenderStep("Freecam")
		t7.Pop()
...
local function CheckMacro(p1) --[[ CheckMacro | Line: 450 | Upvalues: UserInputService (copy), v18 (ref), t3 (copy), RunService (copy), t7 (copy), StartFreecam (copy) ]]
	for i = 1, #p1 - 1 do
...
ContextActionService:BindActionAtPriority("FreecamToggle", function(p1, p2, p3) --[[ HandleActivationInput | Line: 459 | Upvalues: t (copy), LocalPlayer (copy), CheckMacro (copy) ]]
