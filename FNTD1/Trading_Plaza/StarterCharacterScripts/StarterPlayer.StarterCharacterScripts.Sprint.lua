...
function Handler(p1, p2) --[[ Handler | Line: 19 | Upvalues: v2 (ref), Humanoid (copy), v1 (copy), v4 (copy), CharacterWalkSpeed (copy), v6 (copy) ]]
...
Humanoid.Running:connect(function(p1) --[[ Line: 39 | Upvalues: v2 (ref), Humanoid (copy), v1 (copy), v4 (copy), CharacterWalkSpeed (copy), v6 (copy) ]]
