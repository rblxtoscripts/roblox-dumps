...
if LocalPlayer then
	ReplicatedStorage.Remotes.Towers.MetaData.OnClientEvent:Connect(function(p1) --[[ Line: 210 | Upvalues: Towers (copy) ]]
		if not p1 then
			return
		end
		if pcall(function() --[[ Line: 212 | Upvalues: p1 (ref), Towers (ref) ]]
	...
	local t2 = {}
	ReplicatedStorage.Remotes.Misc.OpenPresent.OnServerEvent:Connect(function(p1, p2, p3) --[[ Line: 198 | Upvalues: t2 (copy), t (copy) ]]
		if not t2[p1.Name] then
			t2[p1.Name] = true
			delay(0.5, function() --[[ Line: 201 | Upvalues: t2 (ref), p1 (copy) ]]
				t2[p1.Name] = nil
			end)
