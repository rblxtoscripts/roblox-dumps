...
local t2 = {}
if not UserRaycastUpdateAPI2 then
...
local function Pather(p1, p2, p3) --[[ Pather | Line: 214 | Upvalues: v9 (ref), LocalPlayer (copy), t3 (copy), v10 (ref), v3 (copy), getCollidableExtentsSize (copy), v6 (copy), PathfindingService (copy), v7 (ref), ClickToMoveDisplay (copy), v11 (ref), UserRaycastUpdateAPI2 (copy), v12 (copy), v15 (ref), Workspace (copy) ]]
	local t = {}
	local v1, v2
	if p3 == nil then
		v1 = v9
...
function OnTap(p1, p2, p3) --[[ OnTap | Line: 740 | Upvalues: Workspace (copy), LocalPlayer (copy), t3 (copy), UserRaycastUpdateAPI2 (copy), v15 (ref), v12 (copy), StarterGui (copy), Players (copy), v19 (ref), v20 (ref), v21 (ref), Pather (copy), HandleMoveTo (copy), v8 (ref), ClickToMoveDisplay (copy), t2 (copy), GetEquippedTool (copy) ]]
...
function v22.DisconnectEvents(p1) --[[ DisconnectEvents | Line: 892 ]]
...
function v22.OnPreferredInputChanged(p1) --[[ OnPreferredInputChanged | Line: 929 | Upvalues: LocalPlayer (copy), UserInputService (copy) ]]
	local Character = LocalPlayer.Character
...
function v22.OnCharacterAdded(p1, p2) --[[ OnCharacterAdded | Line: 941 | Upvalues: UserInputService (copy), t (copy), v19 (ref), v20 (ref), v21 (ref), ClickToMoveDisplay (copy), GuiService (copy) ]]
	p1:DisconnectEvents()
	p1.inputBeganConn = UserInputService.InputBegan:Connect(function(p12, p2) --[[ Line: 944 | Upvalues: p1 (copy), t (ref), v19 (ref), v20 (ref), v21 (ref), ClickToMoveDisplay (ref) ]]
	...
	p1.inputEndedConn = UserInputService.InputEnded:Connect(function(p12, p2) --[[ Line: 967 | Upvalues: p1 (copy), v19 (ref) ]]
		if p12.UserInputType == Enum.UserInputType.Touch then
	...
	p1.menuOpenedConnection = GuiService.MenuOpened:Connect(function() --[[ Line: 990 | Upvalues: v19 (ref), v20 (ref), v21 (ref) ]]
		if v19 then
			v19:Cancel()
			v19 = nil
		end
...
function v22.Start(p1) --[[ Start | Line: 1029 ]]
	p1:Enable(true)
end
function v22.Stop(p1) --[[ Stop | Line: 1033 ]]
	p1:Enable(false)
end
function v22.CleanupPath(p1) --[[ CleanupPath | Line: 1037 | Upvalues: v19 (ref), v20 (ref), v21 (ref) ]]
	if v19 then
		v19:Cancel()
		v19 = nil
	end
...
function v22.Enable(p1, p2, p3, p4) --[[ Enable | Line: 1041 | Upvalues: LocalPlayer (copy), v19 (ref), v20 (ref), v21 (ref), UserInputService (copy), Keyboard (copy) ]]
	if p2 then
...
function v22.OnRenderStepped(p1, p2) --[[ OnRenderStepped | Line: 1086 | Upvalues: v19 (ref) ]]
	p1.isJumping = false
	if v19 then
...
function v22.UpdateMovement(p1, p2) --[[ UpdateMovement | Line: 1121 ]]
...
function v22.UpdateJump(p1) --[[ UpdateJump | Line: 1130 ]] end
function v22.SetShowPath(p1, p2) --[[ SetShowPath | Line: 1135 | Upvalues: v7 (ref) ]]
	v7 = p2
end
function v22.GetShowPath(p1) --[[ GetShowPath | Line: 1139 | Upvalues: v7 (ref) ]]
	return v7
end
function v22.SetWaypointTexture(p1, p2) --[[ SetWaypointTexture | Line: 1143 | Upvalues: ClickToMoveDisplay (copy) ]]
	ClickToMoveDisplay.SetWaypointTexture(p2)
end
function v22.GetWaypointTexture(p1) --[[ GetWaypointTexture | Line: 1147 | Upvalues: ClickToMoveDisplay (copy) ]]
	return ClickToMoveDisplay.GetWaypointTexture()
end
function v22.SetWaypointRadius(p1, p2) --[[ SetWaypointRadius | Line: 1151 | Upvalues: ClickToMoveDisplay (copy) ]]
	ClickToMoveDisplay.SetWaypointRadius(p2)
end
function v22.GetWaypointRadius(p1) --[[ GetWaypointRadius | Line: 1155 | Upvalues: ClickToMoveDisplay (copy) ]]
	return ClickToMoveDisplay.GetWaypointRadius()
end
function v22.SetEndWaypointTexture(p1, p2) --[[ SetEndWaypointTexture | Line: 1159 | Upvalues: ClickToMoveDisplay (copy) ]]
	ClickToMoveDisplay.SetEndWaypointTexture(p2)
end
function v22.GetEndWaypointTexture(p1) --[[ GetEndWaypointTexture | Line: 1163 | Upvalues: ClickToMoveDisplay (copy) ]]
	return ClickToMoveDisplay.GetEndWaypointTexture()
end
function v22.SetWaypointsAlwaysOnTop(p1, p2) --[[ SetWaypointsAlwaysOnTop | Line: 1167 | Upvalues: ClickToMoveDisplay (copy) ]]
	ClickToMoveDisplay.SetWaypointsAlwaysOnTop(p2)
end
function v22.GetWaypointsAlwaysOnTop(p1) --[[ GetWaypointsAlwaysOnTop | Line: 1171 | Upvalues: ClickToMoveDisplay (copy) ]]
	return ClickToMoveDisplay.GetWaypointsAlwaysOnTop()
end
function v22.SetFailureAnimationEnabled(p1, p2) --[[ SetFailureAnimationEnabled | Line: 1175 | Upvalues: v8 (ref) ]]
	v8 = p2
end
function v22.GetFailureAnimationEnabled(p1) --[[ GetFailureAnimationEnabled | Line: 1179 | Upvalues: v8 (ref) ]]
	return v8
end
function v22.SetIgnoredPartsTag(p1, p2) --[[ SetIgnoredPartsTag | Line: 1183 | Upvalues: UpdateIgnoreTag (copy) ]]
	UpdateIgnoreTag(p2)
end
function v22.GetIgnoredPartsTag(p1) --[[ GetIgnoredPartsTag | Line: 1187 | Upvalues: v16 (ref) ]]
	return v16
end
function v22.SetUseDirectPath(p1, p2) --[[ SetUseDirectPath | Line: 1191 | Upvalues: v9 (ref) ]]
	v9 = p2
end
function v22.GetUseDirectPath(p1) --[[ GetUseDirectPath | Line: 1195 | Upvalues: v9 (ref) ]]
	return v9
end
function v22.SetAgentSizeIncreaseFactor(p1, p2) --[[ SetAgentSizeIncreaseFactor | Line: 1199 | Upvalues: v10 (ref) ]]
	v10 = p2 / 100 + 1
end
function v22.GetAgentSizeIncreaseFactor(p1) --[[ GetAgentSizeIncreaseFactor | Line: 1203 | Upvalues: v10 (ref) ]]
	return (v10 - 1) * 100
end
function v22.SetUnreachableWaypointTimeout(p1, p2) --[[ SetUnreachableWaypointTimeout | Line: 1207 | Upvalues: v11 (ref) ]]
	v11 = p2
end
function v22.GetUnreachableWaypointTimeout(p1) --[[ GetUnreachableWaypointTimeout | Line: 1211 | Upvalues: v11 (ref) ]]
	return v11
end
function v22.SetUserJumpEnabled(p1, p2) --[[ SetUserJumpEnabled | Line: 1215 ]]
	p1.jumpEnabled = p2
...
function v22.GetUserJumpEnabled(p1) --[[ GetUserJumpEnabled | Line: 1222 ]]
	return p1.jumpEnabled
end
function v22.MoveTo(p1, p2, p3, p4) --[[ MoveTo | Line: 1226 | Upvalues: LocalPlayer (copy), Pather (copy), HandleMoveTo (copy) ]]
	local Character = LocalPlayer.Character
